...
/* [cgpt_i76edit_level_renames_v4:high] Runtime RDEF payload helper. Iterates road list through
   i76edit_export_road_records, then writes three EXIT terminators. */
