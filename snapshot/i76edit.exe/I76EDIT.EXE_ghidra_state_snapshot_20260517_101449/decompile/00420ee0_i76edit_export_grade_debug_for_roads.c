...
/* [cgpt_i76edit_level_renames_v4:medium] Opens grade.txt, walks roads/nodes, emits road grading
   diagnostics, and calls road cleanup when invalid edge state is detected. */
