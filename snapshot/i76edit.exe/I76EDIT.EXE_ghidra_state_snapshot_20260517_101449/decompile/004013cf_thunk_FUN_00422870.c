...

{
  ...
  puStack_1c = (ushort *)i76edit_get_terrain_plane_row_ptr((int)param_1,1);
  puStack_38 = i76edit_get_terrain_plane_row_ptr((int)param_1,2);
  ...
  uStack_44 = i76edit_find_zone_cell_origin_by_zone_id((int)param_1,0,0);
  ...
  *apuStack_5c[2] = 0xffffffff;
  ...
  do {
    ...
    do {
      uVar2 = iVar9 + iVar3;
      iVar9 = iVar9 + 1;
      uVar2 = i76edit_get_or_create_zone_surface_sample(uVar2,(uint)puStack_3c,100);
      *puVar5 = uVar2;
      puVar5 = puVar5 + 1;
    } while (iVar9 < 0x81);
    iVar6 = iVar6 + 1;
  ...
  uStack_4c = 0;
  uStack_48 = 2;
  uStack_44 = i76edit_find_zone_cell_origin_by_zone_id((int)apuStack_5c[3],0,2);
  ...
  do {
    ...
    do {
      ...
      iVar3 = iVar3 + 1;
      uVar2 = i76edit_get_or_create_zone_surface_sample(uVar2,uStack_44._4_4_,100);
      *puVar7 = uVar2;
      puVar7 = puVar7 + 1;
    } while (iVar3 < 0x81);
