...

{
  ...
  do {
    ...
    while( true ) {
      ...
      if ((uStack_90 & 1) == 0) {
        iVar4 = i76edit_object_type_has_runtime_position_override(iStack_d4);
        if (iVar4 != 0) {
          uVar7 = i76edit_find_zone_cell_origin_by_zone_id
                            (aiStack_f0[0],aiStack_f0[1],aiStack_f0[2]);
          uVar3 = i76edit_get_or_create_zone_surface_sample
                            ((uint)uVar7,(uint)((ulonglong)uVar7 >> 0x20),0);
