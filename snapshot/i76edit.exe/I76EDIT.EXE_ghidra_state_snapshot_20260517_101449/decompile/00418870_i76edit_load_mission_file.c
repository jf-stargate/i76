/*
 * Program: I76EDIT.EXE
 * Function: i76edit_load_mission_file
 * Entry: 00418870
 * Signature: undefined __cdecl i76edit_load_mission_file(char * param_1)
 */


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* [cgpt_i76edit_level_renames_v2:high] Mission load path. Evidence: 'Opening %s...', 'Loading
   Elevations...', 'Loading Objects...', 'Loading Roads...', 'Loading Paths...', 'Loading
   Terrain...', and invalid mission-file message. */

void __cdecl i76edit_load_mission_file(char *param_1)

{
  ...
  local_120 = 0;
  local_12c = 0;
  i76edit_initialize_terrain_buffers(0);
  thunk_FUN_00409e50();
  thunk_FUN_0040ce70();
  i76edit_set_status_bar_text(s_Clearing_Zones____00436708);
  thunk_FUN_0041e990();
  _sprintf(local_100,s_Opening__s____004366f8,param_1);
  i76edit_set_status_bar_text(local_100);
  _FileHandle = __open(param_1,0x8000);
  if (_FileHandle == 0) {
    _sprintf(local_100,s___s__is_not_an_Iterstate__76_Mis_004366c4,param_1);
    MessageBoxA(DAT_01642370,local_100,s_File_Error_004366b4,0);
    __close(0);
    return;
  }
  __read(_FileHandle,local_100,4);
  iVar3 = _strncmp(local_100,&DAT_004366ac,4);
  if (iVar3 != 0) {
    _sprintf(local_100,s___s__is_not_an_Iterstate__76_Mis_004366c4,param_1);
    MessageBoxA(DAT_01642370,local_100,s_File_Error_004366b4,0);
    __close(_FileHandle);
  ...
  i76edit_set_status_bar_text(s_Loading____0043669c);
  __read(_FileHandle,&local_124,4);
  do {
    if (local_124 == &DAT_00444e45) {
      i76edit_set_status_bar_text(s_Ready__00434590);
      __close(_FileHandle);
      return;
    }
    if (local_124 < (undefined *)0x44414f53) {
      if (local_124 == (undefined *)0x44414f52) {
        i76edit_set_status_bar_text(s_Loading_Roads____0043665c);
        i76edit_load_road_records(_FileHandle,unaff_EBP,unaff_EDI,unaff_ESI);
      }
      else {
        if (local_124 != &DAT_004a424f) {
LAB_004189f0:
          _sprintf(local_100,s_Invalid_chunk_tag___00436610);
          _strncat(local_100,(char *)&local_124,4);
          uVar5 = 0xffffffff;
          pcVar9 = (char *)&DAT_0043660c;
          break;
        }
        i76edit_set_status_bar_text(s_Loading_Objects____00436644);
        i76edit_load_object_records(_FileHandle,local_11c);
        if (local_11c < 3) {
          thunk_FUN_0040f470();
          thunk_FUN_0040f170();
        }
        else {
          i76edit_load_linked_object_records(_FileHandle,unaff_EBP,unaff_EDI,unaff_ESI);
        }
      }
    }
    else if (local_124 < (undefined *)0x454e4f5b) {
      if (local_124 == (undefined *)0x454e4f5a) {
        i76edit_set_status_bar_text(s_Loading_Terrain____00436684);
        iVar3 = 0;
        i76edit_load_workspace_surface_terrain_tables(_FileHandle,local_120);
        do {
          i76edit_convert_zone_id_to_cell_xy(iVar3,&local_118,&local_104);
          if (local_118 != -1) {
            thunk_FUN_004187e0(iVar3,local_120);
          }
          iVar3 = iVar3 + 1;
        } while (iVar3 < 0x50);
        if (3 < local_120) {
          i76edit_load_extended_zone_records(_FileHandle,unaff_EBP,unaff_EDI,unaff_ESI);
        }
      }
      else {
        if (local_124 != (undefined *)0x444c5257) goto LAB_004189f0;
        if (local_12c < 8) {
...
LAB_00419ddc:
        ...
        __ltoa(DAT_016420ea,local_114,10);
        SendDlgItemMessageA(DAT_0164239c,0x409,0xc,0,(LPARAM)local_114);
        __ltoa(DAT_01641fc0,local_114,10);
        SendDlgItemMessageA(DAT_0164239c,0x403,0xc,0,(LPARAM)local_114);
        __ltoa(DAT_01642046,local_114,10);
        SendDlgItemMessageA(DAT_0164239c,0x404,0xc,0,(LPARAM)local_114);
      }
    }
    else if (local_124 < (undefined *)0x56454c46) {
      if (local_124 == (undefined *)0x56454c45) {
        i76edit_set_status_bar_text(s_Loading_Elevations____00436628);
        local_128 = &DAT_0163ce70;
        do {
          iVar3 = 0;
          __read(_FileHandle,local_128,200);
          pbVar7 = local_128;
          do {
            iVar4 = 0;
            pbVar11 = local_128;
          ...
          local_128 = local_128 + 200;
        } while (local_128 < &DAT_01640cf0);
      }
      else {
        if (local_124 != (undefined *)0x48544150) goto LAB_004189f0;
        i76edit_set_status_bar_text(s_Loading_Paths____00436670);
        i76edit_load_path_records();
      }
    }
    else {
      if (local_124 == (undefined *)0x5645524f) {
        _DstBuf_00 = &local_11c;
      }
      else if (local_124 == (undefined *)0x56455254) {
        _DstBuf_00 = &local_120;
      }
      else {
        if (local_124 != (undefined *)0x56455257) goto LAB_004189f0;
        _DstBuf_00 = &local_12c;
      }
