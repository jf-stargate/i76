/*
 * Program: I76EDIT.EXE
 * Function: thunk_FUN_0040a400
 * Entry: 0040113b
 * Signature: int __cdecl thunk_FUN_0040a400(int param_1, int param_2)
 */


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

int __cdecl thunk_FUN_0040a400(int param_1,int param_2)

{
  ...
  iStack_e4 = 0;
  FUN_0040a680(param_2);
  puStack_cc = &DAT_004a424f;
  iStack_c8 = 0x6c;
  puStack_e8 = &DAT_00439be8;
  do {
    thunk_FUN_0041e120(s_Zone__00434774);
    for (puVar1 = (undefined4 *)*puStack_e8; puVar1 != (undefined4 *)0x0;
      ...
      uVar8 = thunk_FUN_004121d0(*piVar2,piVar2[1],piVar2[2]);
      iStack_c4 = piVar2[0x16];
      iStack_c0 = piVar2[0x17];
      iVar3 = thunk_FUN_0041f5a0(piVar2[7]);
      iStack_d4 = (int)uVar8;
      iStack_d0 = (int)((ulonglong)uVar8 >> 0x20);
      if (iVar3 == 0) {
        fVar7 = FUN_0040a660(iStack_d0);
        fVar11 = (float)fVar7;
        fVar10 = (float)piVar2[3] * _DAT_004320b0;
        fVar7 = FUN_0040a660(iStack_d4);
