/*
 * Program: I76EDIT.EXE
 * Function: thunk_FUN_0040d9d0
 * Entry: 004013ac
 * Signature: int * __cdecl thunk_FUN_0040d9d0(int param_1, int param_2)
 */


int * __cdecl thunk_FUN_0040d9d0(int param_1,int param_2)
        ...
        do {
          if ((((iVar11 < 0) || (iVar9 < 0)) || (0x4f < iVar11)) || (0x4f < iVar9)) {
            *piVar5 = -1;
            ...
            iVar4 = thunk_FUN_00411b30(iVar11,iVar9,0);
            *piVar5 = iVar4;
          }
          piVar5 = piVar5 + 1;
          iVar11 = iVar11 + 1;
