...

{
  ...
  iVar3 = thunk_FUN_00411ba0(param_1,param_2,1);
  puVar4 = (undefined4 *)thunk_FUN_00412300(aiStack_c,param_1,param_2);
  uVar6 = *puVar4;
  uVar1 = puVar4[1];
  uVar2 = puVar4[2];
  puVar5 = _malloc(0x78);
  ...
  *(undefined1 *)((int)puVar5 + 0x75) = 0;
  ...
  puVar5[7] = 1;
  puVar5[3] = 0;
  uVar6 = thunk_FUN_0041c430((&DAT_00439be8)[iVar3],(undefined4 *)0x0,(int)puVar5);
