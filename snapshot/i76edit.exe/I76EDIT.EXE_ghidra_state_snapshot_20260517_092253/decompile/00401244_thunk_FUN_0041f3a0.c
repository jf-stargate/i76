...

{
  ...
  iVar3 = thunk_FUN_00411ba0(param_1,param_2,(uint)(param_4 != 0));
  if (iVar3 != -1) {
    piVar4 = (int *)thunk_FUN_00412300((int *)apuStack_c,param_1,param_2);
    iVar1 = *piVar4;
    iVar3 = piVar4[1];
    iVar2 = piVar4[2];
    apuStack_c[0] = thunk_FUN_00412120(iVar1,param_4);
    iVar3 = (iVar2 * 0x80 + iVar3) * 2;
    *(undefined2 *)(iVar3 + (int)apuStack_c[0]) = param_3;
    if (param_4 == 0) {
      if (DAT_004376f4 == 10) {
        uVar5 = thunk_FUN_0041f2b0(param_1,param_2,5);
        *(short *)(iVar3 + (int)apuStack_c[0]) = (short)uVar5;
      }
      puVar6 = thunk_FUN_00412120(iVar1,3);
