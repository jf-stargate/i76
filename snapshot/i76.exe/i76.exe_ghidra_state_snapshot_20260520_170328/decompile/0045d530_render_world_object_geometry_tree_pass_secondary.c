...
/* [cgpt i76.exe GEO lighting/render renames v33; confidence=high] Secondary/alternate world-object
   geometry traversal. Mirrors the primary traversal for another render pass or object-list branch.
   
   I76 rename v43: render_world_object_geo_recursive_pass
   Recursive/child world-object GEO render pass. */
