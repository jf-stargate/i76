/*
 * Program: i76.exe
 * Function: activate_runtime_camera_mode_14_fixed_offset_view_b
 * Entry: 004084a0
 * Signature: undefined __cdecl activate_runtime_camera_mode_14_fixed_offset_view_b(undefined4 param_1)
 */


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* cgpt rename v5 runtime camera cluster: Runtime camera mode table id 0x14; initializes a second
   fixed offset object view with alternate yaw/offset constants and installs
   update_runtime_camera_orbit_offset_callback. */

void __cdecl activate_runtime_camera_mode_14_fixed_offset_view_b(undefined4 param_1)

{
  ...
  DAT_004c2928 = 0;
  DAT_004c292c = 0x40490fda;
  _DAT_004c2920 = 0;
  DAT_004c2938 = 0xbfc00000;
  DAT_004c293c = 0;
  DAT_004c2940 = 0xbe800000;
