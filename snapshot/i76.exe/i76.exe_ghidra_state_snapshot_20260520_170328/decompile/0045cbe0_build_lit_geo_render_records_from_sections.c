...
/* [cgpt i76.exe GEO lighting/render renames v33; confidence=high] Builds depth-sortable render
   records from runtime GEO sections. Transforms positions, indexes transformed normals/lighting by
   entry.secondary_index, copies UVs, and emits 0x18-byte lit render vertices.
   
   I76 rename v43: build_lit_geo_render_records_from_sections
   Builds lit render records from GEO sections; transform/light/material path. */
