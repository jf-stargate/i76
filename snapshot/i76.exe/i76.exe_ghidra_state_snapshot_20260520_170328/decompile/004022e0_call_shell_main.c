...

{
  ...
  pFVar3 = GetProcAddress(shell_handle,s_ShellMain_004c228c);
  if (pFVar3 == (FARPROC)0x0) {
    return 1;
  }
  DAT_00504bec = GetProcAddress(shell_handle,s_ShellWindowProc_004c227c);
  ...
  uVar5 = (*pFVar3)(shell_handle,0,param_2,param_3,param_1,-(uint)(DAT_004f9f20 != 0) & 0x643920,
