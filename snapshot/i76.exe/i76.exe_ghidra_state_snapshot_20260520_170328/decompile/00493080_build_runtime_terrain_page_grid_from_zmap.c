/*
 * Program: i76.exe
 * Function: build_runtime_terrain_page_grid_from_zmap
 * Entry: 00493080
 * Signature: undefined4 __cdecl build_runtime_terrain_page_grid_from_zmap(undefined4 param_1, int param_2, float param_3)
 */
...
/* cgpt label refinement v19: was terrain_map_runtime_terrain_map_context_helper_00493080. Remove
   ...
   I76 rename v43: build_runtime_terrain_page_grid_from_zmap
   Builds 128x128 runtime page-pointer grid from 80x80 ZMAP using +24/+24 offset. */

undefined4 __cdecl
build_runtime_terrain_page_grid_from_zmap(undefined4 param_1,int param_2,float param_3)

{
  ...
  puVar5 = &g_runtime_terrain_page_pointer_grid;
  ...
  do {
    ...
    do {
      if (*pbVar1 != 0xff) {
        ...
        (&g_runtime_terrain_page_pointer_grid)[iVar4 + iVar3] = uVar2;
      }
      pbVar1 = pbVar1 + 1;
      iVar4 = iVar4 + 1;
    } while (iVar4 < 0x50);
