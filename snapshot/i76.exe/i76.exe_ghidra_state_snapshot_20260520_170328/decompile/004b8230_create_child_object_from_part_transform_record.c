...
/* [cgpt i76.exe GEO runtime/render renames v30; confidence=medium-high] Creates/initializes a
   vehicle child object from a VDF/VGEO part transform record and links geometry/bounds state.
   
   I76 rename v43: copy_odef_basis_position_to_runtime_transform
   Copies ODEF basis +0x08..+0x28 and float position +0x2c/+0x30/+0x34 into runtime transform block.
    */
