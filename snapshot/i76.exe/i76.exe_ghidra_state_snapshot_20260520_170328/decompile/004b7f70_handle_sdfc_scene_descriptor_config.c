/*
 * Program: i76.exe
 * Function: handle_sdfc_scene_descriptor_config
 * Entry: 004b7f70
 * Signature: undefined4 __cdecl handle_sdfc_scene_descriptor_config(int param_1, int * param_2)
 */


/* cgpt readability rename set E v17: Readability pass set E: vehicle geometry part set context
   helper based on adjacent named subsystem context.
   [cgpt-i76-v36 medium] SDFC handler in scene-object descriptor child table.
   
   I76 rename v43: handle_sdfc_scene_descriptor_header
   SDFC handler in SDF child descriptor table. */

undefined4 __cdecl handle_sdfc_scene_descriptor_config(int param_1,int *param_2)
