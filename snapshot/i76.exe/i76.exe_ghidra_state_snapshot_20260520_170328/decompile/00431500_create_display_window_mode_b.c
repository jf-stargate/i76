/*
 * Program: i76.exe
 * Function: create_display_window_mode_b
 * Entry: 00431500
 * Signature: undefined4 __cdecl create_display_window_mode_b(undefined4 * param_1)
 */


/* i76 first-pass rename
   old_name: FUN_00431500
   suggested_name: create_display_window_mode_b
   basis: Alternate CreateWindowExA display/window creation path. */

undefined4 __cdecl create_display_window_mode_b(undefined4 *param_1)

{
  ...
  *param_1 = 0x280;
  ...
  param_1[0x107] = DAT_004f0040;
  param_1[0x108] = PTR_flip_or_restore_directdraw_front_back_surfaces_004f0044;
  param_1[0x109] = PTR_prepare_smacker_cutscene_display_surface_004f0048;
  param_1[0x10a] = PTR_LAB_004f004c;
  puVar6 = &DAT_004f0050;
  ...
  iVar8 = initialize_display_surface_context(param_1,1);
  if (iVar8 == 0) {
    return 0;
  }
