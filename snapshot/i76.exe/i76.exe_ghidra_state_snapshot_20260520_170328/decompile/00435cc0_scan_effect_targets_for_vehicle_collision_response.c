/*
 * Program: i76.exe
 * Function: scan_effect_targets_for_vehicle_collision_response
 * Entry: 00435cc0
 * Signature: undefined4 __cdecl scan_effect_targets_for_vehicle_collision_response(int param_1, int param_2, float * param_3, int * param_4, undefined4 * param_5)
 */


/* cgpt readability rename v13 set A: Vehicle-oriented effect-target scan variant using runtime
   vehicle/object filters and transformed collision candidates. */

undefined4 __cdecl
scan_effect_targets_for_vehicle_collision_response
...
joined_r0x00435e44:
  do {
    ...
    if ((((*piVar9 != param_2) && (local_c0 <= (float)piVar9[0x17])) &&
      ...
      if (iVar7 != 0) {
        iVar7 = *piVar9;
        *param_4 = iVar7;
        iVar7 = is_vehicle_or_actor_runtime_world_object(iVar7);
        piVar8 = g_effect_target_scan_current_node;
        if (iVar7 != 0) {
  ...
  if (g_effect_target_scan_current_node == (int *)0x0) goto code_r0x00435f16;
  goto LAB_00435f3c;
code_r0x00435f16:
