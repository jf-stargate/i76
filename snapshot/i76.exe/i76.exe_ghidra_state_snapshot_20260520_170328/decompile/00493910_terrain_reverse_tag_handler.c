...
/* cgpt whole-binary semantic rename v1: string evidence TREV
   ...
   I76 rename v43: parse_tdef_terrain_definition
   TDEF terrain section handler for ZMAP/ZONE terrain configuration. */
...

{
  ...
  piVar1 = parse_tagged_chunk_descriptor_table
                     (param_1,(byte *)g_tdef_descriptor_table,4,(byte *)0x0,param_2,1,param_3);
