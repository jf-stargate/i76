...
LAB_004b2899:
    sprintf(&g_resource_key_registration_error_buffer,pcVar11,param_1);
    return 0;
  }
  ...
  DAT_006593e0 = 1;
  DAT_006593e4 = 0;
  g_resource_key_table_capacity_or_limit = 2;
...
LAB_004b24ea:
  ...
  _Source = HeapAlloc(g_resource_key_table_heap_handle,0,local_18 * 0x30);
  local_8 = _Source;
  if (_Source == (int *)0x0) {
  ...
  DAT_006593e0 = 1;
  DAT_006593e4 = 0;
  iVar4 = g_resource_key_table_capacity_or_limit * 0x10c;
...
LAB_004b260e:
  if (bVar2) {
    (&DAT_006593e0)[g_resource_key_table_capacity_or_limit * 0x43] = 0;
  }
  else {
    (&DAT_006593e0)[g_resource_key_table_capacity_or_limit * 0x43] = 1;
  }
  (&DAT_006593e4)[g_resource_key_table_capacity_or_limit * 0x43] = 0;
  ...
  g_resource_key_table_entries = HeapAlloc(g_resource_key_table_heap_handle,0,local_18 * 0x30);
  puVar10 = g_resource_key_table_entries;
  ...
  if (g_resource_key_table_entries == (undefined4 *)0x0) {
    fatal_out_of_memory_message((LPCSTR)0x0);
  }
  iVar4 = -1;
  piVar9 = (int *)&DAT_00504c28;
  g_resource_key_table_count = -1;
  param_1 = (char *)0x0;
  piVar6 = _Source;
  if (0 < (int)local_18) {
    do {
...
LAB_004b274c:
      if (iVar8 != 0) {
        g_resource_key_table_count = iVar4 + 1;
        strncpy((char *)(g_resource_key_table_entries + g_resource_key_table_count * 0xc),
                (char *)_Source,0x10);
        iVar4 = g_resource_key_table_count;
        piVar9 = _Source;
      }
      iVar5 = _Source[4];
      if (iVar5 < 0x101) {
        ...
        g_resource_key_table_entries[iVar4 * 0xc + iVar8 + 4] =
             g_resource_key_table_entries[iVar4 * 0xc + iVar8 + 4] |
  ...
  g_resource_key_table_count = iVar4 + 1;
  g_resource_key_table_entries =
       HeapReAlloc(g_resource_key_table_heap_handle,0,g_resource_key_table_entries,
                   g_resource_key_table_count * 0x30);
  HeapFree(g_resource_key_table_heap_handle,0,piVar6);
  fclose(local_4);
