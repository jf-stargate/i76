  ...
  if (DAT_00504bfc == 0) {
    ...
    if (g_resource_debug_log_file != 0) {
      fprintf((FILE *)DAT_005a7c90,s_cache_geom_tex_video_free___d__d_004c2314,
              g_loaded_resource_cache_budget_bytes,g_geo_runtime_heap_bytes_tracked,
              g_vqm_texture_cache_bytes_remaining,DAT_0052b914);
    }
    if (puVar6 != (uint *)0x0) {
      local_1a8 = 0;
...
LAB_004028e3:
          ...
          if ((g_geo_runtime_heap_bytes_tracked < 200000) &&
             (bVar2 = true, g_resource_debug_log_file != 0)) {
