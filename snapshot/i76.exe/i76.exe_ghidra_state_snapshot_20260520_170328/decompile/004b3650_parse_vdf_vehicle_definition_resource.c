...
/* [cgpt i76.exe vehicle asset format renames v16; confidence=high] Parses a BWD2 .vdf vehicle
   definition via descriptor table VDFC/SOBJ/VLOC/VGEO/COLP/WLOC/HLOC/ETBL and performs
   component/resource validation.
   
   I76 rename v43: parse_vdf_vehicle_definition_resource
   VDF vehicle/object definition parser. */
