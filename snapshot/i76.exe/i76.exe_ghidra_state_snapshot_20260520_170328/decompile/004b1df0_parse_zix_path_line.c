...

{
  ...
  do {
    g_resource_key_table_capacity_or_limit = param_2 + 1;
    if (((0xff < g_resource_key_table_capacity_or_limit) ||
        (iVar3 = mission_resource_reference_context_helper_004b20f0(&local_400,0x100,param_1),
        iVar3 == 0)) || (local_400 == '-')) {
      if (((g_resource_key_table_capacity_or_limit == 0x100) &&
          (iVar3 = mission_resource_reference_context_helper_004b20f0(&local_400,0x100,param_1),
          iVar3 != 0)) && (local_400 != '-')) {
        sprintf(&g_resource_key_registration_error_buffer,
                s_More_than__d_zix_paths_specified_004fff1c,0x100);
        return 0;
      }
      return 1;
    }
    sscanf(&local_400,s__s__s_004f4c80,local_300,
           &g_zix_search_path_records + g_resource_key_table_capacity_or_limit * 0x10c);
    pbVar9 = &DAT_004fff44;
    pbVar4 = local_300;
    do {
      bVar2 = *pbVar4;
...
LAB_004b1fef:
    if (iVar3 == 0) {
      ...
      param_2 = g_resource_key_table_capacity_or_limit;
    }
    else {
      ...
      if (iVar3 == 0) {
        ...
        (&DAT_006593e4)[g_resource_key_table_capacity_or_limit * 0x43] = iVar3;
        param_2 = g_resource_key_table_capacity_or_limit;
      }
    }
  } while( true );
