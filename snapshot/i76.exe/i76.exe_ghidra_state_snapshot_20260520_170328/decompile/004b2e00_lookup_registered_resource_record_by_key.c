...
/* [cgpt i76.exe resource/archive rename v11; confidence=high] Looks up the 0x30-byte registered
   ...
   I76 rename v43: find_registered_resource_record_by_key
   Looks up registered resource record by lowercase key. */
...

{
  ...
  if (pvVar4 == (void *)0x0) {
    sprintf(&g_resource_key_registration_error_buffer,s_Couldn_t_find_file___s__004fffe8,param_1);
    ...
    if (local_38 == (undefined4 *)0xffffffff) {
      ...
      if (0 < g_resource_key_table_capacity_or_limit) {
        ...
        do {
          ...
          iVar10 = iVar10 + 1;
          puVar9 = puVar9 + 0x43;
        } while (iVar10 < g_resource_key_table_capacity_or_limit);
      }
