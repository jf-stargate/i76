...

{
  ...
  if (param_2 == 0) {
    puVar5 = (undefined4 *)(&g_odef_spawn_transform_table + param_1 * 0x40);
  }
  else {
    if (param_2 != 1) goto LAB_00451452;
    puVar5 = (undefined4 *)(&g_odef_regen_transform_table + param_1 * 0x40);
  }
  pcVar3 = _Dest + 0x18;
...
LAB_00451452:
  *(uint *)(_Dest + 0x10) = (2 - (uint)(iVar1 != 0)) * 0x10000 | -(uint)(iVar1 != 0) & 0x10;
  ...
  if (local_4c == 0) {
    ...
    iVar4 = bind_odef_vehicle_geometry_context(local_48);
  }
