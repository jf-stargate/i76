...
/* [cgpt i76.exe geo raster span family renames v38; confidence=high] Dispatches lit/textured
   polygon through clip/prepare and draw/span tables using 0x18-byte render vertices.
   
   I76 rename v43: submit_lit_textured_polygon_to_renderer
   Submits lit textured polygon to renderer. */
