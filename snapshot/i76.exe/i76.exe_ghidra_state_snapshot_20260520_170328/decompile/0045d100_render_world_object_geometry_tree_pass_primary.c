...
/* [cgpt i76.exe GEO lighting/render renames v33; confidence=high] Primary world-object geometry
   traversal. Ensures geometry binding, builds lit GEO render records, binds texture sets, and
   submits sorted textured polygons.
   
   I76 rename v43: render_world_object_geo_pass
   Higher-level world-object GEO render pass. */
