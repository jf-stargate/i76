...
/* [cgpt i76.exe vehicle asset format renames v16; confidence=medium] Parses a scene object
   ...
   I76 rename v43: parse_scene_object_descriptor_resource
   Parses SDF child descriptor table 00500b18. */
...

{
  ...
  bVar3 = parse_bwd2_resource_with_descriptor_table(param_3,&g_sdf_child_descriptor_table,6,param_2)
  ;
