...
/* [cgpt i76.exe GEO mesh/render renames v29; confidence=high] Instantiates VDF VGEO part records
   into vehicle child objects, resolves parent names, and registers part basename + .geo cache
   entries.
   
   I76 rename v43: instantiate_vdf_vehicle_geometry_part_sets
   Instantiates VDF geometry part sets. */
