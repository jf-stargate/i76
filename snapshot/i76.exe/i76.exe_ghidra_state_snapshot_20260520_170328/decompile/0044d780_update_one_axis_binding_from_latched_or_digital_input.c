/*
 * Program: i76.exe
 * Function: update_one_axis_binding_from_latched_or_digital_input
 * Entry: 0044d780
 * Signature: int __cdecl update_one_axis_binding_from_latched_or_digital_input(int * param_1)
 */
...
int __cdecl update_one_axis_binding_from_latched_or_digital_input(int *param_1)

{
  ...
  int iVar4;
                    ...
                    /* I76 semantic baseline: update_one_axis_binding_from_latched_or_digital_input
                       Updates one axis binding from latched analog or digital ramp inputs. */
  iVar1 = param_1[5];
