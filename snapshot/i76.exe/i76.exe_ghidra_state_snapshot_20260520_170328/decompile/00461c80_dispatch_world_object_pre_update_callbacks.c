/*
 * Program: i76.exe
 * Function: dispatch_world_object_pre_update_callbacks
 * Entry: 00461c80
 * Signature: undefined __stdcall dispatch_world_object_pre_update_callbacks(void)
 */
...
void dispatch_world_object_pre_update_callbacks(void)
