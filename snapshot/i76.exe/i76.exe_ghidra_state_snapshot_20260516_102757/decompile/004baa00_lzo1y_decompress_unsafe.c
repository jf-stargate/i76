/*
 * Program: i76.exe
 * Function: lzo1y_decompress_unsafe
 * Entry: 004baa00
 * Signature: undefined8 __fastcall lzo1y_decompress_unsafe(undefined4 param_1, undefined4 param_2, byte * param_3, int param_4, byte * param_5, int * param_6)
 */


/* [cgpt i76.exe LZO1Y state labels v25] Embedded LZO 1.00 LZO1Y unsafe decompressor entry; ZFSF
   mode/compression byte 0x04. */

undefined8 __fastcall
lzo1y_decompress_unsafe
...

{
  ...
  bVar4 = *param_3;
  pbVar13 = param_5;
  if (bVar4 < 0x12) goto lzo1y_bb_small_token_literal_or_dispatch;
  uVar6 = (uint)(byte)(bVar4 - 0x11);
  uVar7 = uVar6;
  puVar12 = puVar11;
  if (3 < (byte)(bVar4 - 0x11)) goto lzo1y_bb_copy_literal_run_dwords;
lzo1y_bb_copy_literal_run_tail:
  ...
  if (0xf < (byte)*puVar12) goto lzo1y_bb_main_token_dispatch;
  ...
  *pbVar13 = *pbVar8;
  ...
  pbVar13[2] = pbVar8[2];
  pbVar13 = pbVar13 + 3;
lzo1y_bb_after_match_tail_or_literal_state:
  do {
    uVar6 = (byte)puVar12[-1] & 3;
    if (((byte)puVar12[-1] & 3) == 0) {
      bVar4 = (byte)*puVar12;
      puVar11 = (ushort *)((int)puVar12 + 1);
lzo1y_bb_small_token_literal_or_dispatch:
      uVar6 = (uint)bVar4;
      if (bVar4 < 0x10) break;
    }
    else {
      ...
      if (bVar4 < 0x20) {
        if (bVar4 < 0x10) {
          ...
          *pbVar13 = pbVar13[-1 - ((uVar6 >> 2) + CONCAT31(uVar10,(byte)uVar3) * 4)];
          ...
          pbVar13[1] = bVar4;
          pbVar13 = pbVar13 + 2;
          goto lzo1y_bb_after_match_tail_or_literal_state;
        }
        iVar5 = 0;
        if ((uVar6 & 7) == 0) {
          while( true ) {
        ...
        if (*puVar11 >> 2 < 3) goto code_r0x004bab2a;
      }
lzo1y_bb_copy_match_fast:
      uVar9 = uVar7 >> 2;
      if (uVar9 != 0) {
        do {
        ...
        uVar7 = uVar7 & 3;
        uVar9 = 0;
        if (uVar7 == 0) goto lzo1y_bb_after_match_tail_or_literal_state;
      }
      do {
        bVar4 = *pbVar8;
        pbVar8 = pbVar8 + 1;
    ...
    uVar7 = (uVar6 >> 4) - 1;
    if (2 < uVar1) goto lzo1y_bb_copy_match_fast;
code_r0x004bab2a:
    for (; uVar7 != 0; uVar7 = uVar7 - 1) {
      *pbVar13 = *pbVar8;
      pbVar8 = pbVar8 + 1;
...
lzo1y_bb_copy_literal_run_dwords:
  uVar7 = uVar6 & 3;
  uVar6 = uVar6 >> 2;
  do {
  ...
  goto lzo1y_bb_copy_literal_run_tail;
}
