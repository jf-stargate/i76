/*
 * Program: i76.exe
 * Function: release_world_object_tree_reference
 * Entry: 0045f0f0
 * Signature: LPVOID __cdecl release_world_object_tree_reference(LPVOID param_1, undefined4 param_2)
 */


/* [cgpt i76.exe damage dispatch rename v19; confidence=HIGH] Releases a world-object tree
   reference; decrements refcounts, unlinks/free objects at zero, and returns the released object
   pointer when applicable. */

LPVOID __cdecl release_world_object_tree_reference(LPVOID param_1,undefined4 param_2)
