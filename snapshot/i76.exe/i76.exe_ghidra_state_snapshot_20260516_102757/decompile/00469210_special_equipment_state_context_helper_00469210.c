/*
 * Program: i76.exe
 * Function: special_equipment_state_context_helper_00469210
 * Entry: 00469210
 * Signature: float10 __cdecl special_equipment_state_context_helper_00469210(uint param_1, uint param_2)
 */


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* cgpt label refinement v19: was vehicle_specials_runtime_special_equipment_state_helper_00469210.
   Shorten readability label. */

float10 __cdecl special_equipment_state_context_helper_00469210(uint param_1,uint param_2)
...
LAB_0046949b:
  ...
  if (bVar18) {
    return (float10)*(float *)(puVar14 + 0x14);
  }
  return (float10)*(float *)(puVar14 + 0x10);
}
