 ...
 * Entry: 00409850
 * Signature: undefined __cdecl initialize_fsm_runtime_heap_and_tables(int * param_1)
 */
...
void __cdecl initialize_fsm_runtime_heap_and_tables(int *param_1)

{
  ...
  undefined4 *puVar8;
                    ...
                    /* I76 semantic baseline: initialize_fsm_runtime_heap_and_tables
                       FSM runtime initialization anchor at AI/FSM neighborhood start. */
