...
/* [cgpt i76.exe vehicle asset renames v19; confidence=high] VCFC root callback: copies vehicle
   display/config strings, parses VDF, parses three WDF weapon definitions, parses component CDF
   tables, and copies derived runtime scalars. */
...

{
  ...
  *(undefined4 *)(iVar6 + 0xa9c) = *(undefined4 *)(param_1 + 0x85);
  bVar7 = parse_bwd2_resource_with_descriptor_table
                    ((byte *)(param_1 + 0x18),&DAT_004ff0b0,0xd,param_2);
  ...
  *(float *)(iVar6 + 0xaa0) = fVar1 + fVar2 + fVar3 + *(float *)(iVar6 + 0xaa0);
  ...
  iVar6 = *(int *)(param_2 + 4);
  bVar7 = parse_bwd2_resource_with_descriptor_table
                    ((byte *)s_compnent_cdf_004ffcd0,&DAT_004ff450,0xd,local_b0);
