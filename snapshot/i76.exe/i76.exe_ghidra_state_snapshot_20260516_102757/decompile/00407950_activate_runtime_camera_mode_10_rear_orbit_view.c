/*
 * Program: i76.exe
 * Function: activate_runtime_camera_mode_10_rear_orbit_view
 * Entry: 00407950
 * Signature: undefined __cdecl activate_runtime_camera_mode_10_rear_orbit_view(int * param_1)
 */


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* cgpt rename v5 runtime camera cluster: Runtime camera mode table id 0x10; initializes
   object-relative view with pi yaw/orbit constants and callback LAB_00407ad0. */

void __cdecl activate_runtime_camera_mode_10_rear_orbit_view(int *param_1)
