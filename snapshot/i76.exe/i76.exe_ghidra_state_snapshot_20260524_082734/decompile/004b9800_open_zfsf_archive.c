...
/* [i76 level/static/material baseline v48]
   name: open_zfsf_archive
   confidence: high
   module: resource_zfs
   Opens ZFSF archive. Embedded resource index is required for static SDF child GEO and material
   assets.
...

{
  ...
  char local_e10 [3600];
                    ...
                    /* I76 semantic baseline: open_zfsf_archive
                       Opens/parses ZFSF archive. */
  fseek(param_2,0,0);
  sVar2 = fread(&local_e30,0x1c,1,param_2);
  if (sVar2 == 0) {
    pcVar13 = s_Could_not_read_header_of_file____00500f08;
LAB_004b9aab:
    sprintf(&g_resource_key_registration_error_buffer,pcVar13,param_1);
    return (char *)0x0;
  }
  ...
  pcVar13 = HeapAlloc(g_resource_key_table_heap_handle,0,0x2c);
  if (pcVar13 == (char *)0x0) {
  ...
  *(undefined4 *)(pcVar13 + 0x1c) = local_e1c;
  pvVar3 = HeapAlloc(g_resource_key_table_heap_handle,0,*(int *)(pcVar13 + 0x14) << 2);
  *(LPVOID *)(pcVar13 + 0x24) = pvVar3;
  if (pvVar3 != (LPVOID)0x0) {
    pvVar3 = HeapAlloc(g_resource_key_table_heap_handle,0,local_e20 * 0x24);
...
LAB_004b9959:
  ...
  do {
    if (sVar4 == 0) {
      sprintf(&g_resource_key_registration_error_buffer,s_Could_not_read_dtable__d_of_file_00500ee0,
              iVar11,pcVar13 + 4);
LAB_004b9a5f:
      HeapFree(g_resource_key_table_heap_handle,0,pcVar13);
      return (char *)0x0;
    }
    iVar11 = iVar11 + 1;
    local_e34 = 0;
    *(long *)(*(int *)(pcVar13 + 0x24) + -4 + iVar11 * 4) = local_e18;
    ...
    if (_Offset == 0) {
      *(size_t *)(pcVar13 + 0x18) = sVar2;
      ...
      sprintf(&g_resource_key_registration_error_buffer,s_Header_has__d_dtables__actually___00500ea8
