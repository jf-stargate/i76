...

{
  ...
  *(undefined4 *)StrLookup_Global_Object_exref = uVar8;
  ...
  shell_handle = LoadLibraryA(s_I76SHELL_DLL_004c2630);
  if (shell_handle == (HMODULE)0x0) {
    return 1;
  }
  ...
  g_runtime_terrain_vertex_aux_projected_lighting_buffer =
...
LAB_004034cf:
    ...
    iVar9 = load_iseg_tseg_record_table_context();
    if (iVar9 == 0) {
