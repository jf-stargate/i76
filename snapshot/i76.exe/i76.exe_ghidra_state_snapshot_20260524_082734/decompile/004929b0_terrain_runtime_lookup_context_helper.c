/*
 * Program: i76.exe
 * Function: terrain_runtime_lookup_context_helper
 * Entry: 004929b0
 * Signature: undefined4 __cdecl terrain_runtime_lookup_context_helper(int param_1)
 */
...
/* cgpt label refinement v19: was terrain_map_runtime_terrain_map_context_helper_004929b0. Remove
   ...
   I76 rename v43: terrain_runtime_lookup_context_helper
   Terrain lookup helper adjacent to height/surface path. */

undefined4 __cdecl terrain_runtime_lookup_context_helper(int param_1)
