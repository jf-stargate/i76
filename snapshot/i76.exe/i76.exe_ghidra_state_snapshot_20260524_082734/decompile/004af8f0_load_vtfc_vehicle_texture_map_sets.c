...
/* [i76 level/static/material baseline v48]
   name: load_vtfc_vehicle_texture_map_sets
   confidence: high
   module: material_vtfc
   Loads VTFC vehicle texture map sets. Retained for cross-reference: static material work now shows
   VQM-first is often correct for M06 static GEO material families.
