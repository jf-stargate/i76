/*
 * Program: i76.exe
 * Function: fsm_query_recent_special_damage_source
 * Entry: 0040b0f0
 * Signature: undefined __cdecl fsm_query_recent_special_damage_source(int param_1, int * param_2, int * param_3, int param_4)
 */
...
void __cdecl
fsm_query_recent_special_damage_source(int param_1,int *param_2,int *param_3,int param_4)

{
  ...
  char local_50 [80];
                    ...
                    /* I76 semantic baseline: fsm_query_recent_special_damage_source
                       FSM query reading recent special damage source candidate. */
