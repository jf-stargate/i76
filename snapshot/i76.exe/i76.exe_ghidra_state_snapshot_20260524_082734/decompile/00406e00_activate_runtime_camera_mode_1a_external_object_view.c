/*
 * Program: i76.exe
 * Function: activate_runtime_camera_mode_1a_external_object_view
 * Entry: 00406e00
 * Signature: undefined __cdecl activate_runtime_camera_mode_1a_external_object_view(undefined4 param_1)
 */


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* cgpt rename v5 runtime camera cluster: Runtime camera mode table id 0x1a; initializes an
   object/view mode without copying object orientation anchor fields. */

void __cdecl activate_runtime_camera_mode_1a_external_object_view(undefined4 param_1)
