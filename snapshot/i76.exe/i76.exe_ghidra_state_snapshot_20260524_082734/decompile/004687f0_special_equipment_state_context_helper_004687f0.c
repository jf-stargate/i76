/*
 * Program: i76.exe
 * Function: special_equipment_state_context_helper_004687f0
 * Entry: 004687f0
 * Signature: float10 __cdecl special_equipment_state_context_helper_004687f0(uint param_1, uint param_2)
 */


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* cgpt label refinement v19: was vehicle_specials_runtime_special_equipment_state_helper_004687f0.
   Shorten readability label. */

float10 __cdecl special_equipment_state_context_helper_004687f0(uint param_1,uint param_2)
