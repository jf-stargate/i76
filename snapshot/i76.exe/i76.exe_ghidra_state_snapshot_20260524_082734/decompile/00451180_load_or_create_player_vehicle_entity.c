...

{
  ...
  if (param_3 == 0) {
    puVar5 = (undefined4 *)(&g_odef_spawn_transform_table + param_2 * 0x40);
  }
  else {
    if (param_3 != 1) goto LAB_00451286;
    puVar5 = (undefined4 *)(&g_odef_regen_transform_table + param_2 * 0x40);
  }
  pcVar4 = _Dest + 0x18;
...
LAB_00451286:
  ...
  *(uint *)(_Dest + 0x10) = *(uint *)(_Dest + 0x10) | param_1 << 0x10;
  ...
  if (local_4c == 0) {
    ...
    iVar2 = bind_odef_vehicle_geometry_context(local_48);
  }
