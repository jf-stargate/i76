/*
 * Program: i76.exe
 * Function: clip_screen_xy_lit_polygon_vertices_compact
 * Entry: 0047b8c0
 * Signature: uint * __cdecl clip_screen_xy_lit_polygon_vertices_compact(int param_1, void * param_2, float * param_3, uint * param_4)
 */


/* [cgpt i76.exe GEO raster table renames v35; confidence=high] Screen-space X/Y clipper for compact
   or reduced polygon attribute mode; preserves position/depth/light behavior. */

uint * __cdecl
clip_screen_xy_lit_polygon_vertices_compact(int param_1,void *param_2,float *param_3,uint *param_4)
