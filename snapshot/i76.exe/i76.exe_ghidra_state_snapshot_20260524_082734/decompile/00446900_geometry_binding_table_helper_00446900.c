...

{
  ...
  g_geo_constructor_allocation_list_head = 0;
  g_geo_runtime_heap_bytes_tracked = ((47999999 < local_20[2]) - 1 & 0xfff551a0) + 2000000;
  g_geometry_purge_list_tail = 0;
  g_geometry_heap_handle = HeapCreate(0,0,g_geo_runtime_heap_bytes_tracked);
  if (g_geometry_heap_handle == (HANDLE)0x0) {
    return false;
  }
