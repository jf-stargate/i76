/*
 * Program: i76.exe
 * Function: restart_vehicle_engine_loop_sound
 * Entry: 00424d20
 * Signature: int * __cdecl restart_vehicle_engine_loop_sound(int param_1)
 */


/* cgpt label refinement v18: was start_vehicle_engine_loop_sound. Separate this from 00424bc0; this
   entry is adjacent to stop/restart/runtime sound helpers and should not duplicate the primary
   start name. */

int * __cdecl restart_vehicle_engine_loop_sound(int param_1)
