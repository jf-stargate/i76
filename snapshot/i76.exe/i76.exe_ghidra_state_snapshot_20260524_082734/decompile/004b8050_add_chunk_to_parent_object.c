/*
 * Program: i76.exe
 * Function: add_chunk_to_parent_object
 * Entry: 004b8050
 * Signature: undefined4 __cdecl add_chunk_to_parent_object(int param_1, undefined4 * param_2)
 */


/* cgpt whole-binary semantic rename v1: string evidence parent object not found / unable to add
   chunk
   
   I76 rename v43: handle_schk_add_chunk_to_parent_object
   SCHK handler; adds/attaches chunk to parent object. */

undefined4 __cdecl add_chunk_to_parent_object(int param_1,undefined4 *param_2)
