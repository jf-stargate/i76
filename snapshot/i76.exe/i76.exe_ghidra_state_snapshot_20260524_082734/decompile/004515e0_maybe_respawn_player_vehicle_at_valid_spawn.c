...

{
  ...
  if (g_odef_regen_transform_count != 0) {
    ...
    do {
      ...
      uVar10 = uVar10 + 1;
      pdVar7 = pdVar7 + 8;
    } while (uVar10 < g_odef_regen_transform_count);
  }
  if (uVar10 == g_odef_regen_transform_count) {
    DAT_00540d94 = 1;
    return 0;
  }
  fVar12 = get_network_or_session_runtime_seconds();
  ...
  uVar10 = rand();
  uVar10 = uVar10 % g_odef_spawn_transform_count;
...
LAB_004517fd:
  ...
  goto LAB_004518d9;
LAB_004518b5:
  uVar10 = -(uint)(uVar10 + 1 != g_odef_spawn_transform_count) & uVar10 + 1;
  uVar9 = local_60._0_4_ + 1;
  local_60 = (double)CONCAT44(local_60._4_4_,uVar9);
  if (g_odef_spawn_transform_count <= uVar9) goto LAB_004518d9;
  goto LAB_004517fd;
}
