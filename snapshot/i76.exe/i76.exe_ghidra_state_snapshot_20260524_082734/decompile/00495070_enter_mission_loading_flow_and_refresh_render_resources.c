/*
 * Program: i76.exe
 * Function: enter_mission_loading_flow_and_refresh_render_resources
 * Entry: 00495070
 * Signature: undefined4 __stdcall enter_mission_loading_flow_and_refresh_render_resources(void)
 */
...
/* cgpt label refinement v20: was zone_satellite_map_zone_satellite_map_helper_00495070. Remove
   ...
   [cgpt_i76exe_render_mode_v13] proposed=enter_mission_loading_flow_and_refresh_render_resources ::
...
undefined4 enter_mission_loading_flow_and_refresh_render_resources(void)

{
  ...
  if (iVar2 != 0) {
    puVar3 = &g_player_display_options_block;
    puVar4 = &DAT_00654ba0;
