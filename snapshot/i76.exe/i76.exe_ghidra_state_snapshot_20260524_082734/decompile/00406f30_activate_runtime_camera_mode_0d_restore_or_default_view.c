/*
 * Program: i76.exe
 * Function: activate_runtime_camera_mode_0d_restore_or_default_view
 * Entry: 00406f30
 * Signature: undefined __cdecl activate_runtime_camera_mode_0d_restore_or_default_view(int * param_1)
 */


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* cgpt rename v5 runtime camera cluster: Runtime camera mode table id 0x0d; conditionally restores
   from camera state 0/2, otherwise initializes the default object-relative view. */

void __cdecl activate_runtime_camera_mode_0d_restore_or_default_view(int *param_1)

{
  ...
  if ((g_runtime_display_mode_state == 0) || (g_runtime_display_mode_state == 2)) {
    ...
    if (uVar1 == 1) {
      ...
      DAT_004c2724 = 1;
      g_runtime_display_mode_state = 2;
      DAT_004c2908 = param_1;
      g_runtime_display_mode_change_callback = &LAB_004071a0;
      return;
    }
    if (g_runtime_display_mode_state == 0) {
      DAT_00654b88 = DAT_00654b88 ^ 1;
    }
    ...
    DAT_004c2908 = param_1;
    g_runtime_display_mode_change_callback = &LAB_00406ab0;
  }
  return;
}
