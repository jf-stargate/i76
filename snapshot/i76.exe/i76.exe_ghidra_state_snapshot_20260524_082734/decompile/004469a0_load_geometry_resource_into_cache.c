...
/* [cgpt i76.exe GEO runtime/render renames v30; confidence=high] Loads a .geo resource through the
   ...
   I76 rename v43: load_geo_resource_by_formatted_name
   GEO loader called by SOBJ path after formatting part.geo. */
...

{
  ...
  puVar4[2] = uVar7 + 1;
  if (uVar7 == 0) {
    if (puVar4 == g_geo_constructor_allocation_list_head) {
