/*
 * Program: i76.exe
 * Function: raster_emit_span_callback_mode_00487480
 * Entry: 00487480
 * Signature: undefined __cdecl raster_emit_span_callback_mode_00487480(int * param_1, int * param_2)
 */
...
void __cdecl raster_emit_span_callback_mode_00487480(int *param_1,int *param_2)

{
  ...
  *piVar5 = param_1[10];
  ...
  while (puVar14 != (uint *)(piVar5 + 1)) {
    ...
    _DAT_0059bc30 = (double)(fVar8 * local_c + (float)_DAT_004faf18);
    _DAT_0059bc68 = (double)(fVar8 * local_10 + (float)_DAT_004faf18);
    local_c = fVar6 * local_14 + local_c;
    local_10 = fVar6 * local_1c + local_10;
    param_2 = (int *)(fVar6 * local_18 + fVar7);
    _DAT_0059bc00 =
         (double)(((_DAT_004be778 / (float)param_2) * local_c - (float)DAT_0059bc30) *
                  *(float *)(&DAT_004f9d38 + uVar24 * 4) + (float)_DAT_004faf18);
    _DAT_0059bc08 =
         (double)(((_DAT_004be778 / (float)param_2) * local_10 - (float)DAT_0059bc68) *
                  *(float *)(&DAT_004f9d38 + uVar24 * 4) + (float)_DAT_004faf18);
    if (0 < (int)uVar18 >> 4) {
    ...
    _DAT_0059bc30 = (double)CONCAT44(DAT_0059bc30_4,iVar11);
    _DAT_0059bc68 = (double)CONCAT44(DAT_0059bc68_4,iVar13);
    iVar19 = ((int)uVar18 >> 4) + -1;
    if (-1 < iVar19) {
      _DAT_0059bc30 = (double)CONCAT44(DAT_0059bc30_4,iVar11 - DAT_0059bc00);
      _DAT_0059bc68 = (double)CONCAT44(DAT_0059bc68_4,iVar13 - DAT_0059bc08);
      fVar25 = (float10)(iVar11 - DAT_0059bc00);
      fVar26 = (float10)local_10;
      fVar27 = (float10)_DAT_0059bc68 - (float10)_DAT_004faf18;
      fVar29 = in_ST0;
      ...
      do {
        ...
        iVar11 = DAT_0059bc08;
        iVar13 = DAT_0059bc68 + DAT_0059bc08 + DAT_0059bc08;
        iVar21 = DAT_0059bc30 + DAT_0059bc00 + DAT_0059bc00;
        ...
        *puVar15 = (&DAT_0061b2a0)
                   [CONCAT31((int3)uVar9,
                             *(undefined1 *)
                              ((&DAT_006439d8)[DAT_0059bc68 + DAT_0059bc08 >> 0x10 & DAT_0059bcb0] +
                              (DAT_0059bc30 + DAT_0059bc00 >> 0x10 & DAT_0059bc38))) & 0x1fff];
        iVar13 = iVar13 + iVar11;
        ...
        _DAT_0059bc30 = (double)CONCAT44(DAT_0059bc30_4,iVar20);
        _DAT_0059bc68 = (double)CONCAT44(DAT_0059bc68_4,iVar13);
        iVar19 = iVar19 + -1;
        fVar29 = fVar32;
        fVar32 = fVar28;
