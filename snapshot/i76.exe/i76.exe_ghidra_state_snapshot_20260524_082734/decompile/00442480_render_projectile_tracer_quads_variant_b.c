    ...
    if (piVar9[3] != piVar9[4]) {
      ...
      if (piVar9[3] != piVar9[4]) {
        do {
          ...
          if (piVar9[5] == 2) {
            local_18 = g_runtime_terrain_vertex_xyz_buffer[iVar10 * 9] +
                       g_runtime_terrain_vertex_xyz_buffer[iVar1 * 9];
            local_14 = g_runtime_terrain_vertex_xyz_buffer[iVar1 * 9 + 1] +
                       g_runtime_terrain_vertex_xyz_buffer[iVar10 * 9 + 1];
            fVar6 = g_runtime_terrain_vertex_xyz_buffer[iVar1 * 9 + 2];
          }
          else {
            local_18 = g_runtime_terrain_vertex_xyz_buffer[(iVar3 + 2) * 3] +
                       g_runtime_terrain_vertex_xyz_buffer[iVar10 * 9];
            local_14 = g_runtime_terrain_vertex_xyz_buffer[iVar1 * 9 + 7] +
                       g_runtime_terrain_vertex_xyz_buffer[iVar10 * 9 + 1];
            fVar6 = g_runtime_terrain_vertex_xyz_buffer[iVar1 * 9 + 8];
          }
          local_14 = local_14 * _DAT_004bd2b0;
          local_18 = local_18 * _DAT_004bd2b0;
          local_10 = (fVar6 + g_runtime_terrain_vertex_xyz_buffer[iVar10 * 9 + 2]) * _DAT_004bd2b0;
          iVar4 = software_raster_queue_context_helper_00472c10(param_1,&local_18,10.0);
          if (iVar4 < 1) {
            if (piVar9[5] == 2) {
              puVar5 = i76_runtime_alloc_prepare_terrain_polygon_work_record();
              puVar5[3] = 8;
              *puVar5 = 2;
              puVar5[2] = 0;
              puVar5[1] = piVar9[6];
              ...
              pfVar8 = g_runtime_terrain_vertex_xyz_buffer + iVar1 * 9;
              puVar5[0xd] = *pfVar8;
              puVar5[0xe] = pfVar8[1];
              fVar6 = pfVar8[2];
              ...
              do {
                ...
                *puVar5 = 4;
                ...
                puVar5[1] = uVar2;
                pfVar8 = g_runtime_terrain_vertex_xyz_buffer + (iVar3 + piVar11[-1]) * 3;
                puVar5[7] = *pfVar8;
                puVar5[8] = pfVar8[1];
                puVar5[9] = pfVar8[2];
                ...
                pfVar8 = g_runtime_terrain_vertex_xyz_buffer + (iVar10 * 3 + piVar11[-1]) * 3;
                puVar5[0xd] = *pfVar8;
                puVar5[0xe] = pfVar8[1];
                puVar5[0xf] = pfVar8[2];
                ...
                pfVar8 = g_runtime_terrain_vertex_xyz_buffer + (iVar10 * 3 + *piVar11) * 3;
                puVar5[0x13] = *pfVar8;
                ...
                pfVar8 = g_runtime_terrain_vertex_xyz_buffer + (iVar3 + *piVar11) * 3;
                puVar5[0x19] = *pfVar8;
                ...
                puVar5[4] = fVar6;
                i76_runtime_bin_terrain_polygon_work_record(fVar6);
                piVar11 = piVar11 + 2;
              ...
              *puVar5 = 3;
              ...
              puVar5[0xc] = 0x3f800000;
              puVar5[9] = fVar6;
              pfVar8 = g_runtime_terrain_vertex_xyz_buffer + (iVar3 + 1) * 3;
              puVar5[0xd] = *pfVar8;
              puVar5[0xe] = pfVar8[1];
              puVar5[0xf] = pfVar8[2];
              puVar5[0x12] = 0x3f800000;
              pfVar8 = g_runtime_terrain_vertex_xyz_buffer + (iVar3 + 2) * 3;
              puVar5[0x13] = *pfVar8;
              puVar5[0x14] = pfVar8[1];
              fVar6 = pfVar8[2];
