...
/* [i76 level/static/material baseline v48]
   name: handle_level_odef_obj_record_by_class
   confidence: high
   module: level_object_dispatch
   Main ODEF/OBJ class-dispatch handler. v42/v43 evidence: class-specific resource policy, not all
   VCF and not all SDF. Static classes route to SDF; selected actor/vehicle classes route to VCF;
   spawn/regen markers are special.
