/*
 * Program: i76.exe
 * Function: queue_affine_textured_polygon_variant_0048b310
 * Entry: 0048b310
 * Signature: undefined __cdecl queue_affine_textured_polygon_variant_0048b310(int param_1, float * param_2, int param_3, undefined4 param_4)
 */
...
void __cdecl
queue_affine_textured_polygon_variant_0048b310
    ...
    if (DAT_004f9d80 != (void *)0x0) {
      puVar6 = (undefined4 *)
               initialize_raster_command_record
                         (DAT_004f9d80,param_4,2,raster_emit_span_callback_mode_0048a870);
    }
    local_4 = 0xffffffff;
