  ...
  if (DAT_0051f640 == 0) {
    ...
    do {
      ...
      if (0 < local_80) {
        ...
        do {
          ...
          fVar2 = pfVar12[1];
          fVar3 = pfVar12[2];
          pfVar12 = (float *)sample_runtime_terrain_packed_word
    ...
    if ((iVar13 == 0) && (DAT_0051f5c0 == 0)) {
      process_pending_fsm_instruction_list
                (g_fsm_runtime_global_cluster_end,DAT_0051f638,g_fsm_runtime_table_cluster,
                 DAT_0051f60c,DAT_0051f610,DAT_0051f614,DAT_0051f618,DAT_0051f61c,DAT_0051f620,
                 &DAT_0051f624,&DAT_0051f628,&DAT_0051f62c,DAT_0051f630,DAT_0051f634,
                 g_fsm_runtime_global_cluster_begin);
    }
    else {
