...
/* [cgpt i76.exe ZFSF format renames v13; confidence=high] Retail resource-stack size caller that
   ...
   I76 rename v43: get_registered_resource_payload_size
   Gets registered resource payload size. */
...

{
  ...
  if (pcVar3 == (char *)0x0) {
    ...
    if (iVar4 == -1) {
      sprintf(&g_resource_key_registration_error_buffer,s_Could_not_find_record___s__in_fi_00500024,
              param_1,*(int *)(pcVar2 + 0x108) + 4);
      return 0;
    }
  }
  return iVar4;
