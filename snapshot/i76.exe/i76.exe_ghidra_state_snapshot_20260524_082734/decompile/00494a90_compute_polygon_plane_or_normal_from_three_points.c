/*
 * Program: i76.exe
 * Function: compute_polygon_plane_or_normal_from_three_points
 * Entry: 00494a90
 * Signature: undefined __cdecl compute_polygon_plane_or_normal_from_three_points(float * param_1, float * param_2, float * param_3, float * param_4)
 */
...
/* cgpt label refinement v20: was zone_satellite_map_zone_satellite_map_helper_00494a90. Remove
   ...
   [cgpt-i76-v36 medium] Called by terrain primitive emission to compute polygon plane/normal data.
   
   I76 rename v43: compute_triangle_plane_or_normal
   Called by terrain flatten path to compute plane/normal-like data. */

void __cdecl
compute_polygon_plane_or_normal_from_three_points
