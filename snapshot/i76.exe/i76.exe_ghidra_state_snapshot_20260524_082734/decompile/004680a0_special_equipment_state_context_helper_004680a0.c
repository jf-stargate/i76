/*
 * Program: i76.exe
 * Function: special_equipment_state_context_helper_004680a0
 * Entry: 004680a0
 * Signature: uint __cdecl special_equipment_state_context_helper_004680a0(int param_1)
 */


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* cgpt label refinement v19: was vehicle_specials_runtime_special_equipment_state_helper_004680a0.
   Shorten readability label. */

uint __cdecl special_equipment_state_context_helper_004680a0(int param_1)
