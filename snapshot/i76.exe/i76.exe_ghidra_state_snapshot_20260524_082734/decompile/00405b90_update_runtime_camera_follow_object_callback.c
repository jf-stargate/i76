/*
 * Program: i76.exe
 * Function: update_runtime_camera_follow_object_callback
 * Entry: 00405b90
 * Signature: undefined __stdcall update_runtime_camera_follow_object_callback(void)
 */


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* cgpt readability rename v13 set A: Runtime camera callback used by special object-relative camera
   modes; updates tracked object transform and active camera matrix. */

void update_runtime_camera_follow_object_callback(void)
