/*
 * Program: i76.exe
 * Function: raster_emit_span_callback_mode_00488220
 * Entry: 00488220
 * Signature: undefined __cdecl raster_emit_span_callback_mode_00488220(int * param_1, int * param_2)
 */
...
void __cdecl raster_emit_span_callback_mode_00488220(int *param_1,int *param_2)

{
  ...
  *piVar5 = param_1[10];
  ...
  while (puVar14 != (uint *)(piVar5 + 1)) {
    ...
    _DAT_0059bb90 = (double)(local_c + (float)_DAT_004faf18);
    _DAT_0059bcb8 = (double)(local_14 + (float)_DAT_004faf18);
    ...
    _DAT_0059bb90 = (double)CONCAT44(DAT_0059bb90_4,iVar16);
    _DAT_0059bcb8 = (double)CONCAT44(DAT_0059bcb8_4,iVar13);
    if (-1 < local_20 + -1) {
      do {
        ...
        iVar16 = DAT_0059bc08;
        iVar13 = DAT_0059bcb8 + DAT_0059bc08 + DAT_0059bc08;
        iVar21 = DAT_0059bb90 + DAT_0059bc00 + DAT_0059bc00;
        ...
        *(undefined1 *)local_18 =
             ...
             [CONCAT31((int3)uVar11,
                       *(undefined1 *)
                        ((&DAT_006439d8)[DAT_0059bcb8 + DAT_0059bc08 >> 0x10 & DAT_0059bcb0] +
                        (DAT_0059bb90 + DAT_0059bc00 >> 0x10 & DAT_0059bc38))) & 0x1fff];
        iVar13 = iVar13 + iVar16;
        ...
        *(undefined1 *)((int)local_18 + 0xf) =
        ...
        _DAT_0059bb90 = (double)CONCAT44(DAT_0059bb90_4,iVar20);
        _DAT_0059bcb8 = (double)CONCAT44(DAT_0059bcb8_4,iVar13);
        local_20 = local_20 + -1;
      } while (local_20 != 0);
    }
