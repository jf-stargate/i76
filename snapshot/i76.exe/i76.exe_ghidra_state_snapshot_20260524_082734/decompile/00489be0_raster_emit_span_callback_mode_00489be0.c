/*
 * Program: i76.exe
 * Function: raster_emit_span_callback_mode_00489be0
 * Entry: 00489be0
 * Signature: undefined __cdecl raster_emit_span_callback_mode_00489be0(int * param_1, int * param_2)
 */
...
void __cdecl raster_emit_span_callback_mode_00489be0(int *param_1,int *param_2)

{
  ...
  *piVar6 = param_1[10];
  ...
  while (puVar15 != (uint *)(piVar6 + 1)) {
    ...
    _DAT_0059bd50 = (double)(local_c + (float)_DAT_004faf18);
    _DAT_0059bd58 = (double)(local_14 + (float)_DAT_004faf18);
    ...
    _DAT_0059bd50 = (double)CONCAT44(DAT_0059bd50_4,iVar17);
    _DAT_0059bd58 = (double)CONCAT44(DAT_0059bd58_4,iVar14);
    if (-1 < local_20 + -1) {
      do {
        ...
        iVar17 = DAT_0059bc08;
        iVar14 = DAT_0059bd58 + DAT_0059bc08 + DAT_0059bc08;
        iVar22 = DAT_0059bd50 + DAT_0059bc00 + DAT_0059bc00;
        uVar20 = DAT_0059bba0 + DAT_0059bc50;
        uVar12 = (ulonglong)_DAT_0059bc50 >> 8;
        cVar1 = *(char *)((&DAT_006439d8)[DAT_0059bd58 + DAT_0059bc08 >> 0x10 & DAT_0059bcb0] +
                         (DAT_0059bd50 + DAT_0059bc00 >> 0x10 & DAT_0059bc38));
        ...
        _DAT_0059bd50 = (double)CONCAT44(DAT_0059bd50_4,iVar22);
        _DAT_0059bd58 = (double)CONCAT44(DAT_0059bd58_4,iVar21);
        local_20 = local_20 + -1;
      } while (local_20 != 0);
    }
  }
