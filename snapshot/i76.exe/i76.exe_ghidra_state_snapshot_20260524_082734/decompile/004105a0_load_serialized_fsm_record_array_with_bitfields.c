...
/* cgpt rename v11 astar/ai/fsm-loader cluster: Loads a serialized FSM/AI record array with
   ...
   I76 rename v43: fsm_load_record_array_with_bitfields
   FSM serialized array loader with bitfields. */
  ...
  if (0 < *param_2) {
    ...
    do {
      ...
      *(undefined4 *)(iVar7 + 0x54 + iVar6) = 0;
      g_fsm_serialized_stream_limit_or_base = g_fsm_serialized_stream_limit_or_base + 1;
      iVar7 = *param_1;
      *(undefined4 *)(iVar7 + 0x50 + iVar6) =
           *(undefined4 *)
            (g_fsm_serialized_stream_cursor + -4 + g_fsm_serialized_stream_limit_or_base * 4);
      *(undefined4 *)(iVar7 + 0x54 + iVar6) = 0;
      g_fsm_serialized_stream_limit_or_base = g_fsm_serialized_stream_limit_or_base + 1;
      puVar1 = (uint *)(*param_1 + 0x50 + iVar6);
      lVar8 = __allshl(0x20,(int)(int3)((uint)*(undefined4 *)
                                               (g_fsm_serialized_stream_cursor + -4 +
                                               g_fsm_serialized_stream_limit_or_base * 4) >> 8) >>
                            0x17);
      iVar6 = iVar6 + 0x60;
