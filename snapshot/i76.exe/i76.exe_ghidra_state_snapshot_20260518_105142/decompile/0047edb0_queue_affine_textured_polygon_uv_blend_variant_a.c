/*
 * Program: i76.exe
 * Function: queue_affine_textured_polygon_uv_blend_variant_a
 * Entry: 0047edb0
 * Signature: undefined __cdecl queue_affine_textured_polygon_uv_blend_variant_a(int param_1, float * param_2, int param_3, undefined4 param_4)
 */


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* [cgpt i76.exe geo raster span family renames v38; confidence=medium] Queues affine textured
   polygon variant using palette/blend-table callback family A. */

void __cdecl
queue_affine_textured_polygon_uv_blend_variant_a
    ...
    if (DAT_004f9d80 != (void *)0x0) {
      puVar5 = (undefined4 *)
               initialize_raster_command_record
                         (DAT_004f9d80,param_4,2,raster_emit_textured_blend_spans_variant_a);
    }
    local_4 = 0xffffffff;
