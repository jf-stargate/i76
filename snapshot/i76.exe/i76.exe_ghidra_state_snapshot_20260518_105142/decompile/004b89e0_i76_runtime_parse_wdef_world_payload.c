/*
 * Program: i76.exe
 * Function: i76_runtime_parse_wdef_world_payload
 * Entry: 004b89e0
 * Signature: bool __cdecl i76_runtime_parse_wdef_world_payload(int * param_1, byte * param_2, int * param_3)
 */
...
bool __cdecl i76_runtime_parse_wdef_world_payload(int *param_1,byte *param_2,int *param_3)
