/*
 * Program: i76.exe
 * Function: i76_runtime_compute_terrain_lighting_from_neighbor_heights
 * Entry: 00490fb0
 * Signature: float10 __cdecl i76_runtime_compute_terrain_lighting_from_neighbor_heights(int param_1, int param_2, float param_3)
 */
...
float10 __cdecl
i76_runtime_compute_terrain_lighting_from_neighbor_heights(int param_1,int param_2,float param_3)

{
  ...
  uVar7 = terrain_map_context_helper_00493160(param_1,param_2);
  fVar2 = (float)CONCAT22(extraout_var,uVar7) * fVar5;
  uVar7 = terrain_map_context_helper_00493160(param_1,param_2 + -1);
  uVar8 = terrain_map_context_helper_00493160(param_1 + 1,param_2);
  uVar9 = terrain_map_context_helper_00493160(param_1,param_2 + 1);
  uVar10 = terrain_map_context_helper_00493160(param_1 + -1,param_2);
