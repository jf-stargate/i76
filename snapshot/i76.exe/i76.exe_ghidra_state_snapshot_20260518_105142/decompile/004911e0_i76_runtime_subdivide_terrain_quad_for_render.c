/*
 * Program: i76.exe
 * Function: i76_runtime_subdivide_terrain_quad_for_render
 * Entry: 004911e0
 * Signature: undefined __cdecl i76_runtime_subdivide_terrain_quad_for_render(undefined2 * param_1, undefined2 * param_2, short * param_3, short * param_4)
 */
...
void __cdecl
i76_runtime_subdivide_terrain_quad_for_render
...
LAB_004917bc:
              psVar15 = i76_runtime_alloc_terrain_primitive_node(param_1,param_2,param_3,param_4);
    ...
    i76_runtime_split_terrain_edge_insert_midpoint_vertex(param_1);
    i76_runtime_split_terrain_edge_insert_midpoint_vertex(param_2);
    i76_runtime_split_terrain_edge_insert_midpoint_vertex(param_3);
    i76_runtime_split_terrain_edge_insert_midpoint_vertex(param_4);
    ...
    *(undefined4 *)(puVar10 + 4) = 0;
    ...
    i76_runtime_split_terrain_edge_insert_midpoint_vertex(puVar10);
    psVar15 = (short *)i76_runtime_alloc_terrain_edge_record
                                 (*(undefined2 *)(*(int *)(param_1 + 2) + 2),
                                  *(undefined2 *)(*(int *)(puVar10 + 2) + 2));
    psVar16 = (short *)i76_runtime_alloc_terrain_edge_record
                                 (*(undefined2 *)(*(int *)(puVar10 + 2) + 2),
