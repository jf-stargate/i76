...

{
  ...
  iVar7 = *(int *)(DAT_005244d0 + -4 + DAT_005244d4 * 4);
  *param_2 = iVar7;
  if (iVar7 == 0) {
    *param_1 = 0;
    return;
  ...
  *(undefined4 *)((int)pvVar2 + 0x10b8) = 0;
  ...
  if (0 < *param_2) {
    do {
      DAT_005244d4 = DAT_005244d4 + 1;
      puVar3[0x42a] = *(undefined4 *)(DAT_005244d0 + -4 + DAT_005244d4 * 4);
      DAT_005244d4 = DAT_005244d4 + 1;
      iVar1 = *(int *)(DAT_005244d0 + -4 + DAT_005244d4 * 4);
      iVar5 = 0x28;
      puVar4 = puVar3;
      do {
        DAT_005244d4 = DAT_005244d4 + 1;
        iVar5 = iVar5 + -1;
        *puVar4 = *(undefined4 *)(DAT_005244d0 + -4 + DAT_005244d4 * 4);
        puVar4 = puVar4 + 1;
      } while (iVar5 != 0);
