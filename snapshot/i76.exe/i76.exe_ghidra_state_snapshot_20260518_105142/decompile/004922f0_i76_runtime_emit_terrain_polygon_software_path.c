/*
 * Program: i76.exe
 * Function: i76_runtime_emit_terrain_polygon_software_path
 * Entry: 004922f0
 * Signature: undefined4 __cdecl i76_runtime_emit_terrain_polygon_software_path(int param_1, int param_2, int param_3)
 */
...
undefined4 __cdecl
i76_runtime_emit_terrain_polygon_software_path(int param_1,int param_2,int param_3)
  ...
  if (0 < param_2) {
    ...
    do {
      ...
      if (g_terrain_cached_high_color_resource_mode != 0) {
        param_3 = *(int *)(g_runtime_terrain_vertex_projected_or_scaled_buffer + 8 + *piVar5 * 0xc);
      }
      *piVar7 = param_3;
      piVar7 = piVar7 + 6;
      param_2 = param_2 + -1;
