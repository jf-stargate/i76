          ...
          if (extraout_ST0_00 - (float10)local_38 <= (float10)_DAT_004be0c8) {
            ...
            if ((local_14 <= _DAT_004be0d0) &&
              ...
              transform_vec3_array_by_matrix
                        (g_runtime_terrain_vertex_xyz_buffer,*(float **)(iVar4 + 0xc),
                         *(int *)(iVar4 + 4),local_78);
              fVar11 = local_8;
              ...
              local_24 = g_runtime_terrain_vertex_xyz_buffer + *(int *)(iVar4 + 4) * 3;
              compute_geo_vertex_lighting_from_normals
                        (local_24,g_runtime_terrain_vertex_xyz_buffer,*(int *)(iVar4 + 0x10),
                         (float *)&DAT_005dd380,local_78,*(float *)(iVar4 + 8));
              fVar11 = local_8;
              for (iVar4 = *(int *)(iVar4 + 0x14); local_8 = fVar11, iVar4 != 0;
                  iVar4 = *(int *)(iVar4 + 0x30)) {
                piVar5 = i76_runtime_prepare_terrain_polygon_material_or_light();
                ...
                if (0 < iVar8) {
                  ...
                  do {
                    ...
                    *piVar9 = *(int *)(local_20 + 0x4c);
                    ...
                    pfVar3 = g_runtime_terrain_vertex_xyz_buffer + iVar8 * 3;
                    piVar9[-4] = (int)*pfVar3;
...
LAB_0045c802:
                i76_runtime_bin_terrain_primitive_for_scan_or_span_render((float)piVar5[4]);
                fVar11 = local_8;
              }
            }
          }
