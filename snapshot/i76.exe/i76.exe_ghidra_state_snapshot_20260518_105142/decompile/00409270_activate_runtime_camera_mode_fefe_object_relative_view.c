/*
 * Program: i76.exe
 * Function: activate_runtime_camera_mode_fefe_object_relative_view
 * Entry: 00409270
 * Signature: undefined __cdecl activate_runtime_camera_mode_fefe_object_relative_view(int * param_1)
 */


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* cgpt rename v5 runtime camera cluster: Runtime camera mode table id 0xfefe sentinel/special
   entry; initializes object-relative camera state using computed orientation and callback
   FUN_00405b90. */

void __cdecl activate_runtime_camera_mode_fefe_object_relative_view(int *param_1)

{
  ...
  DAT_004c2724 = 0;
  g_runtime_display_mode_state = 6;
  ...
  g_runtime_display_mode_change_callback = update_runtime_camera_follow_object_callback;
  return;
}
