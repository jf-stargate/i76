/*
 * Program: i76.exe
 * Function: world_reader_null_record_handler
 * Entry: 004b8e20
 * Signature: bool __cdecl world_reader_null_record_handler(int param_1, undefined4 * param_2)
 */


/* cgpt whole-binary semantic rename v1: string evidence null */

bool __cdecl world_reader_null_record_handler(int param_1,undefined4 *param_2)
