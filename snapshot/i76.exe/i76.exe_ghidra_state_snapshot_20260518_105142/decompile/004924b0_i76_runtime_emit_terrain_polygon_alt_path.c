/*
 * Program: i76.exe
 * Function: i76_runtime_emit_terrain_polygon_alt_path
 * Entry: 004924b0
 * Signature: undefined4 __cdecl i76_runtime_emit_terrain_polygon_alt_path(int param_1, int param_2, float param_3)
 */
...
undefined4 __cdecl i76_runtime_emit_terrain_polygon_alt_path(int param_1,int param_2,float param_3)

{
  ...
  piVar3 = i76_runtime_prepare_terrain_polygon_material_or_light();
  piVar3[3] = 0;
  ...
  if (0 < param_2) {
    ...
    do {
      ...
      pfVar5[-2] = pfVar7[1];
      pfVar5[-1] = pfVar7[2];
      *pfVar5 = *(float *)(g_runtime_terrain_vertex_projected_or_scaled_buffer + iVar4) -
                _DAT_0059c55c;
      pfVar5[1] = *(float *)(g_runtime_terrain_vertex_projected_or_scaled_buffer + 4 + iVar4) -
                  _DAT_0059c550;
      if (g_terrain_cached_high_color_resource_mode != 0) {
        param_3 = *(float *)(g_runtime_terrain_vertex_projected_or_scaled_buffer + 8 + iVar4);
      }
      pfVar5[2] = param_3;
      pfVar5 = pfVar5 + 6;
      param_1 = param_1 + -1;
  ...
  *piVar3 = iVar6;
  ...
  i76_runtime_bin_terrain_primitive_for_scan_or_span_render((float)piVar3[4]);
