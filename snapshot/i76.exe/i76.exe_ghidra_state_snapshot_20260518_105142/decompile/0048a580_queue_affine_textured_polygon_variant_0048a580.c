/*
 * Program: i76.exe
 * Function: queue_affine_textured_polygon_variant_0048a580
 * Entry: 0048a580
 * Signature: undefined __cdecl queue_affine_textured_polygon_variant_0048a580(int param_1, float * param_2, int param_3, undefined4 param_4)
 */
...
void __cdecl
queue_affine_textured_polygon_variant_0048a580
...

{
  ...
  if (0 < param_3) {
    ...
    if (DAT_004f9d80 != (void *)0x0) {
      puVar6 = (undefined4 *)
               initialize_raster_command_record
                         (DAT_004f9d80,param_4,2,raster_emit_span_callback_mode_00489be0);
    }
    local_4 = 0xffffffff;
    ...
    if (iVar5 != 0) {
      ...
      puVar6[6] = fVar2 * local_30 + fVar1 * local_24 + fVar3 * local_18;
      puVar6[0x16] = fVar2 * local_2c + fVar1 * local_20 + fVar3 * local_14;
      puVar6[0x17] = fVar2 * local_28 + fVar1 * local_1c + fVar3 * local_10;
    }
  }
  ExceptionList = local_c;
  return;
