/*
 * Program: i76.exe
 * Function: i76_runtime_bin_terrain_primitive_for_scan_or_span_render
 * Entry: 0048fe10
 * Signature: int * __cdecl i76_runtime_bin_terrain_primitive_for_scan_or_span_render(float param_1)
 */
...
int * __cdecl i76_runtime_bin_terrain_primitive_for_scan_or_span_render(float param_1)

{
  ...
  if (iVar8 == 1) {
    ...
    i76_runtime_add_terrain_primitive_to_scan_buckets
