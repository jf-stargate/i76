/*
 * Program: i76.exe
 * Function: ordnance_effect_log_tag
 * Entry: 004ac3d0
 * Signature: bool __cdecl ordnance_effect_log_tag(int param_1, float param_2)
 */
...
bool __cdecl ordnance_effect_log_tag(int param_1,float param_2)

{
  ...
  local_ac = *(float *)(param_1 + 0x38) * local_9c + *(float *)(param_1 + 0x20) * local_b4 + fVar1;
  ...
  local_b0 = *(float *)(param_1 + 0x24) * local_b4 +
             *(float *)(param_1 + 0x2c) * local_ac + *(float *)(param_1 + 0x28) * local_b0;
