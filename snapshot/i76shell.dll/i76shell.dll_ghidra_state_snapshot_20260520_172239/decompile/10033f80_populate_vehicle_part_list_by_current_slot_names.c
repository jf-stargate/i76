 ...
 * Function: populate_vehicle_part_list_by_current_slot_names
 * Entry: 10033f80
 * Signature: undefined __cdecl populate_vehicle_part_list_by_current_slot_names(undefined * param_1, int param_2, int param_3)
 */


void __cdecl
populate_vehicle_part_list_by_current_slot_names(undefined *param_1,int param_2,int param_3)
...
LAB_10034092:
                ...
                if (bVar1 != pbVar5[1]) goto LAB_10034092;
                pbVar4 = pbVar4 + 2;
                pbVar5 = pbVar5 + 2;
              } while (bVar1 != 0);
              iVar3 = 0;
