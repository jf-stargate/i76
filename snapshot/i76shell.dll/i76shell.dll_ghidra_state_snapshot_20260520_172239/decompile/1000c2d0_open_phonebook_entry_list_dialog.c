 ...
 * Function: open_phonebook_entry_list_dialog
 * Entry: 1000c2d0
 * Signature: undefined __cdecl open_phonebook_entry_list_dialog(int * param_1)
 */


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void __cdecl open_phonebook_entry_list_dialog(int *param_1)

{
  ...
  draw_mw2_image_subresource_to_shell_surface
            (DAT_100cc518,g_shell_ui_image_record_ptr_100f4f90,0xc,*param_1,param_1[1],param_1[2],
             param_1[3]);
