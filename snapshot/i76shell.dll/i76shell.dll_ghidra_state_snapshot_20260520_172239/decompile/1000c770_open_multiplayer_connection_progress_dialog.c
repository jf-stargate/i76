 ...
 * Function: open_multiplayer_connection_progress_dialog
 * Entry: 1000c770
 * Signature: undefined __cdecl open_multiplayer_connection_progress_dialog(int * param_1)
 */


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void __cdecl open_multiplayer_connection_progress_dialog(int *param_1)

{
  ...
  if (puVar5 != (undefined4 *)0x0) {
    ...
    fill_shell_surface_rect_from_buffer(DAT_100cc518,puVar5,iVar3 + 6,iVar4 + iVar2,iVar1,6);
  ...
  if (puVar5 != (undefined4 *)0x0) {
    ...
    fill_shell_surface_rect_from_buffer(DAT_100cc518,puVar5,iVar1 + iVar3,iVar2 + 6,6,iVar4);
    HeapFree(DAT_10051c50,1,puVar5);
  }
  draw_mw2_image_subresource_to_shell_surface
            (DAT_100cc518,g_shell_ui_image_record_ptr_100f4f90,0xd,*DAT_100533b8,DAT_100533b8[1],
