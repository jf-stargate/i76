 ...
 * Function: open_modal_scroll_list_dialog_with_selection
 * Entry: 1000b2e0
 * Signature: undefined __cdecl open_modal_scroll_list_dialog_with_selection(int * param_1, int param_2, int param_3)
 */


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void __cdecl open_modal_scroll_list_dialog_with_selection(int *param_1,int param_2,int param_3)

{
  ...
  draw_mw2_image_subresource_to_shell_surface
            (DAT_100cc518,g_shell_ui_image_record_ptr_100f4f90,param_2,*param_1,param_1[1],
             param_1[2],param_1[3]);
  ...
  if (param_3 < param_1[8]) {
    DAT_100533c0[7] = param_3;
  }
  else {
    DAT_100533c0[7] = 0;
  }
