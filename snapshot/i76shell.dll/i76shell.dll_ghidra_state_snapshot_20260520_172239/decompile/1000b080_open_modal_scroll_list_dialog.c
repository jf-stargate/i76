 ...
 * Function: open_modal_scroll_list_dialog
 * Entry: 1000b080
 * Signature: undefined __cdecl open_modal_scroll_list_dialog(int * param_1, int param_2)
 */


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void __cdecl open_modal_scroll_list_dialog(int *param_1,int param_2)
