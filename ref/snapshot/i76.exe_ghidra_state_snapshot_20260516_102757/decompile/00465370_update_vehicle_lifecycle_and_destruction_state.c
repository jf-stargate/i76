...

{
  ...
  float10 fVar9;
                    ...
                    /* I76 semantic baseline: update_vehicle_lifecycle_and_destruction_state
                       Updates vehicle lifecycle/destruction transitions, cleanup,
                       sounds/effects/weapon removal. */
