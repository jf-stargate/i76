...

{
  ...
  if (param_1 != (char *)0x0) {
    if ((-1 < *param_2) && (*param_2 < g_registered_resource_record_count)) {
      do {
        bVar1 = zfsf_payload_wrapper_context_helper_004b9e10
                          ((char *)(*param_2 * 0x30 + g_registered_resource_records),param_1);
        if (CONCAT31(extraout_var,bVar1) != 0) {
          iVar2 = *param_2 * 0x30 + g_registered_resource_records;
          *param_2 = *param_2 + 1;
          return iVar2;
        }
        iVar2 = *param_2;
        *param_2 = iVar2 + 1;
      } while (iVar2 + 1 < g_registered_resource_record_count);
      return 0;
    }
  }
  return 0;
