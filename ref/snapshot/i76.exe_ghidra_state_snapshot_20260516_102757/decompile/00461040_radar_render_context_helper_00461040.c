/*
 * Program: i76.exe
 * Function: radar_render_context_helper_00461040
 * Entry: 00461040
 * Signature: undefined __cdecl radar_render_context_helper_00461040(int * param_1)
 */


/* cgpt label refinement v19: was radar_classifier_specials_radar_render_helper_00461040. Shorten
   readability label. */

void __cdecl radar_render_context_helper_00461040(int *param_1)

{
  ...
  if ((((param_1[0x1c] != 0) && (iVar1 = *(int *)(param_1[0x1c] + 0x434), iVar1 != 0)) &&
    ...
    local_4 = piVar2;
    if ((piVar3 != (int *)0x0) &&
       (piVar8 = (int *)piVar3[8], local_4 = piVar3, (int *)piVar3[8] == (int *)0x0)) {
      piVar8 = piVar2;
    }
    param_1 = (int *)0x0;
    do {
      ...
      if (uVar4 != 0) {
        ...
        if (((iVar5 != 0) && (uVar4 != uVar6)) || ((uVar4 != 0 && (uVar4 != uVar6)))) {
          param_1 = piVar8;
        }
      }
      piVar8 = (int *)piVar8[8];
    ...
    } while (piVar8 != local_4);
    if ((param_1 != (int *)0x0) && (param_1 != local_4)) {
      *(undefined1 *)(local_4 + 7) = 0x69;
