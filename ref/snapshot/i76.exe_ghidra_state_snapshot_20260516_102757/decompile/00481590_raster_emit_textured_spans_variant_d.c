/*
 * Program: i76.exe
 * Function: raster_emit_textured_spans_variant_d
 * Entry: 00481590
 * Signature: undefined __cdecl raster_emit_textured_spans_variant_d(int * param_1, int * param_2)
 */
...
void __cdecl raster_emit_textured_spans_variant_d(int *param_1,int *param_2)

{
  ...
  *piVar6 = param_1[10];
  ...
  while (puVar13 != (uint *)(piVar6 + 1)) {
    ...
    _DAT_0059bd78 = (double)(local_8 + (float)_DAT_004faf18);
    _DAT_0059bd80 = (double)(local_14 + (float)_DAT_004faf18);
    ...
    _DAT_0059bd78 = (double)CONCAT44(DAT_0059bd78_4,iVar18);
    _DAT_0059bd80 = (double)CONCAT44(DAT_0059bd80_4,iVar12);
    ...
    if (-1 < local_18 + -1) {
      do {
        ...
        iVar18 = DAT_0059bc08;
        iVar12 = DAT_0059bd80 + DAT_0059bc08 + DAT_0059bc08;
        iVar19 = DAT_0059bd78 + DAT_0059bc00 + DAT_0059bc00;
        bVar1 = *(byte *)((&DAT_006439d8)[DAT_0059bd80 + DAT_0059bc08 >> 0x10 & DAT_0059bcb0] +
                         (DAT_0059bd78 + DAT_0059bc00 >> 0x10 & DAT_0059bc38));
        ...
        _DAT_0059bd78 = (double)CONCAT44(DAT_0059bd78_4,iVar19);
        _DAT_0059bd80 = (double)CONCAT44(DAT_0059bd80_4,iVar12);
        local_18 = local_18 + -1;
      } while (local_18 != 0);
    }
