    ...
    if (piVar9[3] != piVar9[4]) {
      ...
      if (piVar9[3] != piVar9[4]) {
        do {
          ...
          if (piVar9[5] == 2) {
            local_18 = DAT_005dd320[iVar1 * 9] + DAT_005dd320[iVar10 * 9];
            local_14 = DAT_005dd320[iVar10 * 9 + 1] + DAT_005dd320[iVar1 * 9 + 1];
            local_10 = DAT_005dd320[iVar10 * 9 + 2] + DAT_005dd320[iVar1 * 9 + 2];
          }
          else {
            local_18 = DAT_005dd320[(iVar4 + 2) * 3] + DAT_005dd320[iVar10 * 9];
            local_14 = DAT_005dd320[iVar10 * 9 + 1] + DAT_005dd320[iVar1 * 9 + 7];
            local_10 = DAT_005dd320[iVar1 * 9 + 8] + DAT_005dd320[iVar10 * 9 + 2];
          }
          ...
          if (iVar5 < 1) {
            if (piVar9[5] == 2) {
              puVar6 = terrain_map_context_helper_00490590();
              puVar6[3] = 8;
              *puVar6 = 2;
              puVar6[2] = 0;
              puVar6[1] = piVar9[6];
              ...
              puVar6[4] = fVar3;
              terrain_map_context_helper_0048fe10(fVar3);
            }
            else {
              ...
              do {
                ...
                *puVar6 = 4;
                ...
                puVar6[1] = uVar2;
                pfVar7 = DAT_005dd320 + (iVar4 + piVar11[-1]) * 3;
                puVar6[7] = *pfVar7;
                puVar6[8] = pfVar7[1];
                puVar6[9] = pfVar7[2];
                ...
                pfVar7 = DAT_005dd320 + (iVar10 * 3 + piVar11[-1]) * 3;
                puVar6[0xd] = *pfVar7;
                puVar6[0xe] = pfVar7[1];
                puVar6[0xf] = pfVar7[2];
                ...
                pfVar7 = DAT_005dd320 + (iVar10 * 3 + *piVar11) * 3;
                puVar6[0x13] = *pfVar7;
                ...
                pfVar7 = DAT_005dd320 + (iVar4 + *piVar11) * 3;
                puVar6[0x19] = *pfVar7;
