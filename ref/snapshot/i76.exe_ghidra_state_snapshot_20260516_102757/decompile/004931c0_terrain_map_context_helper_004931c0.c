/*
 * Program: i76.exe
 * Function: terrain_map_context_helper_004931c0
 * Entry: 004931c0
 * Signature: undefined __cdecl terrain_map_context_helper_004931c0(float * param_1, double param_2, undefined4 param_3, undefined4 param_4)
 */
...
void __cdecl
terrain_map_context_helper_004931c0
  ...
  if (((0x2800 - local_c | 0x2800 - local_14 | local_c | local_14) & 0x80000000) == 0) {
    ...
    if ((double)CONCAT44(param_4,param_3) - (double)iVar6 <= param_2 - (double)iVar5) {
      ...
      if ((iVar8 < 0x4000) && (uVar9 < 0x4000)) {
        uVar7 = *(ushort *)((&DAT_00644380)[iVar8] + uVar9 * 2) & 0xfff;
      }
      else {
        uVar7 = 0;
      }
      ...
      if ((iVar8 < 0x4000) && (uVar10 < 0x4000)) {
        uVar7 = *(ushort *)((&DAT_00644380)[iVar8] + uVar10 * 2) & 0xfff;
      }
      else {
        uVar7 = 0;
      }
      ...
      if ((iVar5 < 0x4000) && (uVar10 < 0x4000)) {
        uVar7 = *(ushort *)((&DAT_00644380)[iVar5] + uVar10 * 2) & 0xfff;
      }
      else {
        uVar7 = 0;
      }
      ...
      if ((iVar5 < 0x4000) && (uVar10 < 0x4000)) {
        fVar4 = (float)(*(ushort *)((&DAT_00644380)[iVar5] + uVar10 * 2) & 0xfff);
      }
      else {
        fVar4 = 0.0;
      }
