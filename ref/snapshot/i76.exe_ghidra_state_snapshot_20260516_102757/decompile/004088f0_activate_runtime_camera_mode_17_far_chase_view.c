/*
 * Program: i76.exe
 * Function: activate_runtime_camera_mode_17_far_chase_view
 * Entry: 004088f0
 * Signature: undefined __cdecl activate_runtime_camera_mode_17_far_chase_view(undefined4 param_1)
 */


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* cgpt rename v5 runtime camera cluster: Runtime camera mode table id 0x17; initializes a far
   chase-style view using distance 100.0 and callback LAB_00408a10. */

void __cdecl activate_runtime_camera_mode_17_far_chase_view(undefined4 param_1)

{
  ...
  DAT_004c2724 = 0;
  g_runtime_display_mode_state = 3;
  DAT_004c2908 = param_1;
  g_runtime_display_mode_change_callback = &LAB_00408a10;
  return;
}
