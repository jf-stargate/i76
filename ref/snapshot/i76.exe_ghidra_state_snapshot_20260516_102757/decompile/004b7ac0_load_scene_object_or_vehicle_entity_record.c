...

{
  ...
  {
    spawn_location_lookup_context_helper_00450f90((int)piVar1,0);
    return 1;
  }
  if ((*(int *)(param_1 + 100) == 1) && (iVar5 = _strnicmp(s_regen_00500c48,pcVar4,8), iVar5 == 0))
  {
    spawn_location_lookup_context_helper_00450f90((int)piVar1,1);
    return 1;
  }
  ppvVar10 = local_94;
  ...
  case 0x53:
    ...
    bVar3 = parse_bwd2_resource_with_descriptor_table(pbVar6,&DAT_00500b18,6,(byte *)local_94);
  ...
  if (((iVar5 != 0x50) && (iVar5 != 0x52)) && (iVar5 != 0x53)) {
    if (local_8c == 0) {
      ...
      iVar5 = vehicle_geometry_part_binding_context_helper_004b81c0(local_88);
    }
