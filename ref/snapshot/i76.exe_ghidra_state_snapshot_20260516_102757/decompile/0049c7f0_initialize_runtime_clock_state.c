/*
 * Program: i76.exe
 * Function: initialize_runtime_clock_state
 * Entry: 0049c7f0
 * Signature: undefined __stdcall initialize_runtime_clock_state(void)
 */
...
void initialize_runtime_clock_state(void)

{
  ...
  int iVar4;
                    ...
                    /* I76 semantic baseline: initialize_runtime_clock_state
                       Initializes GetTickCount-based runtime clock state and frame delta defaults.
                        */
