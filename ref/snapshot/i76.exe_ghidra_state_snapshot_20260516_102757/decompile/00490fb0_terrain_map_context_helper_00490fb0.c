/*
 * Program: i76.exe
 * Function: terrain_map_context_helper_00490fb0
 * Entry: 00490fb0
 * Signature: float10 __cdecl terrain_map_context_helper_00490fb0(int param_1, int param_2, float param_3)
 */
...
float10 __cdecl terrain_map_context_helper_00490fb0(int param_1,int param_2,float param_3)
