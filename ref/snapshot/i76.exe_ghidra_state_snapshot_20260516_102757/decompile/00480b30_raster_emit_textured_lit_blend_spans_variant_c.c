/*
 * Program: i76.exe
 * Function: raster_emit_textured_lit_blend_spans_variant_c
 * Entry: 00480b30
 * Signature: undefined __cdecl raster_emit_textured_lit_blend_spans_variant_c(int * param_1, int * param_2)
 */
...
/* [cgpt i76.exe geo raster span family renames v38; confidence=medium] Affine textured+lit span
   callback variant using blend table C. */

void __cdecl raster_emit_textured_lit_blend_spans_variant_c(int *param_1,int *param_2)

{
  ...
  *piVar6 = param_1[10];
  ...
  while (puVar13 != (uint *)(piVar6 + 1)) {
    ...
    iVar15 = (int)uVar18 >> 4;
    _DAT_0059bd28 = (double)(fVar9 * fVar7 + (float)_DAT_004faf18);
    _DAT_0059bc28 = (double)(fVar9 * local_8 + (float)_DAT_004faf18);
    param_2 = (int *)(fVar10 * local_c + fVar7);
    local_8 = fVar10 * (float)local_14 + local_8;
    local_18 = (undefined4 *)(fVar10 * local_10 + fVar8);
    _DAT_0059bc00 =
         (double)(((_DAT_004be778 / (float)local_18) * (float)param_2 - (float)DAT_0059bd28) *
                  *(float *)(&DAT_004f9d38 + uVar17 * 4) + (float)_DAT_004faf18);
    _DAT_0059bc08 =
         (double)(((_DAT_004be778 / (float)local_18) * local_8 - (float)DAT_0059bc28) *
                  *(float *)(&DAT_004f9d38 + uVar17 * 4) + (float)_DAT_004faf18);
    fVar22 = in_ST0;
    if (0 < iVar15) {
    ...
    _DAT_0059bd28 = (double)CONCAT44(DAT_0059bd28_4,iVar12);
    _DAT_0059bc28 = (double)CONCAT44(DAT_0059bc28_4,iVar19);
    iVar15 = iVar15 + -1;
    in_ST0 = fVar22;
    if (-1 < iVar15) {
      _DAT_0059bd28 = (double)CONCAT44(DAT_0059bd28_4,iVar12 - DAT_0059bc00);
      _DAT_0059bc28 = (double)CONCAT44(DAT_0059bc28_4,iVar19 - DAT_0059bc08);
      fVar23 = (float10)(iVar12 - DAT_0059bc00);
      fVar24 = (float10)local_8;
      in_ST0 = (float10)_DAT_0059bc28 - (float10)_DAT_004faf18;
      ...
      do {
        ...
        iVar12 = DAT_0059bc08;
        iVar19 = DAT_0059bc28 + DAT_0059bc08 + DAT_0059bc08;
        iVar20 = DAT_0059bd28 + DAT_0059bc00 + DAT_0059bc00;
        bVar1 = *(byte *)((&DAT_006439d8)[DAT_0059bc28 + DAT_0059bc08 >> 0x10 & DAT_0059bcb0] +
                         (DAT_0059bd28 + DAT_0059bc00 >> 0x10 & DAT_0059bc38));
        ...
        _DAT_0059bd28 = (double)CONCAT44(DAT_0059bd28_4,iVar20);
        _DAT_0059bc28 = (double)CONCAT44(DAT_0059bc28_4,iVar19);
        iVar15 = iVar15 + -1;
        fVar22 = fVar28;
        fVar28 = fVar25;
