/*
 * Program: i76.exe
 * Function: dispatch_world_object_post_update_callbacks
 * Entry: 00461d50
 * Signature: undefined __stdcall dispatch_world_object_post_update_callbacks(void)
 */


/* [cgpt i76.exe runtime loop refinement v23; confidence=HIGH] Per-frame world-object callback pass
   after major simulation update. */

void dispatch_world_object_post_update_callbacks(void)

{
  ...
  do {
    while( true ) {
      ...
      do {
        if (*piVar5 == iVar6) goto LAB_00461df6;
        piVar5 = piVar5 + 0xd;
        iVar4 = iVar4 + 1;
...
LAB_00461df6:
      piVar5 = piVar1;
      if ((code *)(&DAT_004f76f0)[iVar4 * 0xd] != (code *)0x0) {
        (*(code *)(&DAT_004f76f0)[iVar4 * 0xd])(pvVar3);
      }
    }
