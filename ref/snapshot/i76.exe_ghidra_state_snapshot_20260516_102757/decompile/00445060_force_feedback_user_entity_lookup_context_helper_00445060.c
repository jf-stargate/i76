  ...
  do {
    ...
    if (1 < local_40[4]) {
      ...
      transform_vec3_array_by_matrix
                (DAT_005dd320,(float *)(local_40 + 5),iVar7,(float *)(param_1 + 0x40));
      iVar7 = iVar7 + -2;
      local_34 = 0;
      pfVar6 = DAT_005dd320;
      if (0 < iVar7) {
        do {
          ...
          if ((local_4 < _DAT_004bd354) &&
             ...
             pfVar6 = DAT_005dd320, iVar4 < 1)) {
            iVar4 = local_34 + DAT_004f22ec;
            iVar2 = local_34 + DAT_004f22f4;
            if (_DAT_004bd358 <=
                DAT_005dd320[iVar8 * 3 + 1] *
                ((DAT_005dd320[iVar4 * 3] - DAT_005dd320[iVar8 * 3]) *
                 (DAT_005dd320[iVar1 * 3 + 2] - DAT_005dd320[iVar8 * 3 + 2]) -
                (DAT_005dd320[iVar4 * 3 + 2] - DAT_005dd320[iVar8 * 3 + 2]) *
                (DAT_005dd320[iVar1 * 3] - DAT_005dd320[iVar8 * 3])) +
                DAT_005dd320[iVar8 * 3 + 2] *
                ((DAT_005dd320[iVar4 * 3 + 1] - DAT_005dd320[iVar8 * 3 + 1]) *
                 (DAT_005dd320[iVar1 * 3] - DAT_005dd320[iVar8 * 3]) -
                (DAT_005dd320[iVar4 * 3] - DAT_005dd320[iVar8 * 3]) *
                (DAT_005dd320[iVar1 * 3 + 1] - DAT_005dd320[iVar8 * 3 + 1])) +
                ((DAT_005dd320[iVar4 * 3 + 2] - DAT_005dd320[iVar8 * 3 + 2]) *
                 (DAT_005dd320[iVar1 * 3 + 1] - DAT_005dd320[iVar8 * 3 + 1]) -
                (DAT_005dd320[iVar4 * 3 + 1] - DAT_005dd320[iVar8 * 3 + 1]) *
                (DAT_005dd320[iVar1 * 3 + 2] - DAT_005dd320[iVar8 * 3 + 2])) *
                DAT_005dd320[iVar8 * 3]) {
              puVar5 = terrain_map_context_helper_00490590();
              puVar5[3] = 2;
              *puVar5 = 4;
              puVar5[2] = 0xc0;
              puVar5[1] = 0xfe;
              pfVar6 = DAT_005dd320 + iVar8 * 3;
              puVar5[7] = *pfVar6;
              puVar5[8] = pfVar6[1];
              puVar5[9] = pfVar6[2];
              puVar5[0xc] = 0;
              pfVar6 = DAT_005dd320 + iVar4 * 3;
              puVar5[0xd] = *pfVar6;
              puVar5[0xe] = pfVar6[1];
              fVar3 = pfVar6[2];
              puVar5[0x12] = 0;
              puVar5[0xf] = fVar3;
              pfVar6 = DAT_005dd320 + iVar1 * 3;
              puVar5[0x13] = *pfVar6;
              puVar5[0x14] = pfVar6[1];
              fVar3 = pfVar6[2];
              puVar5[0x18] = 0;
              puVar5[0x15] = fVar3;
              pfVar6 = DAT_005dd320 + iVar2 * 3;
              puVar5[0x19] = *pfVar6;
