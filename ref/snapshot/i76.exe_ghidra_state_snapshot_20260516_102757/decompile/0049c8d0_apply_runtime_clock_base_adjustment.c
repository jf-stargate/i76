/*
 * Program: i76.exe
 * Function: apply_runtime_clock_base_adjustment
 * Entry: 0049c8d0
 * Signature: undefined __cdecl apply_runtime_clock_base_adjustment(float param_1, int param_2)
 */
...
void __cdecl apply_runtime_clock_base_adjustment(float param_1,int param_2)

{
  short sVar1;
  float10 fVar2;
  
                    /* I76 semantic baseline: apply_runtime_clock_base_adjustment
                       Medium-confidence timing adjustment helper. */
