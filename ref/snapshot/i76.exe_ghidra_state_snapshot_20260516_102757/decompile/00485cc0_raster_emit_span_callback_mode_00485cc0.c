/*
 * Program: i76.exe
 * Function: raster_emit_span_callback_mode_00485cc0
 * Entry: 00485cc0
 * Signature: undefined __cdecl raster_emit_span_callback_mode_00485cc0(int * param_1, int * param_2)
 */
...
void __cdecl raster_emit_span_callback_mode_00485cc0(int *param_1,int *param_2)

{
  ...
  *piVar5 = param_1[10];
  ...
  while (puVar12 != (uint *)(piVar5 + 1)) {
    ...
    _DAT_0059bd08 = (double)(fVar8 * fVar6 + (float)_DAT_004faf18);
    _DAT_0059bd18 = (double)(fVar8 * local_8 + (float)_DAT_004faf18);
    param_2 = (int *)(fVar9 * local_c + fVar6);
    local_8 = fVar9 * (float)local_14 + local_8;
    local_18 = (undefined4 *)(fVar9 * local_10 + fVar7);
    _DAT_0059bc00 =
         (double)(((_DAT_004be778 / (float)local_18) * (float)param_2 - (float)DAT_0059bd08) *
                  *(float *)(&DAT_004f9d38 + uVar19 * 4) + (float)_DAT_004faf18);
    _DAT_0059bc08 =
         (double)(((_DAT_004be778 / (float)local_18) * local_8 - (float)DAT_0059bd18) *
                  *(float *)(&DAT_004f9d38 + uVar19 * 4) + (float)_DAT_004faf18);
    fVar22 = in_ST0;
    if (0 < iVar15) {
    ...
    if ((int)DAT_0059bd38 - (int)puVar13 != 0) {
      if (((int)DAT_0059bd38 - (int)puVar13 & 1U) == 0) goto LAB_00485fc7;
      iVar20 = DAT_0059bd18 + DAT_0059bc08;
      iVar11 = DAT_0059bd08 + DAT_0059bc00;
      *puVar13 = (&DAT_0061b2a0)
                 [DAT_0059bc50 +
                  (uint)*(byte *)((&DAT_006439d8)[DAT_0059bd18 >> 0x10 & DAT_0059bcb0] +
                                 (DAT_0059bd08 >> 0x10 & DAT_0059bc38))];
...
LAB_00485fc7:
    ...
    _DAT_0059bd08 = (double)CONCAT44(DAT_0059bd08_4,iVar11);
    _DAT_0059bd18 = (double)CONCAT44(DAT_0059bd18_4,iVar20);
    iVar15 = iVar15 + -1;
    in_ST0 = fVar22;
    if (-1 < iVar15) {
      _DAT_0059bd08 = (double)CONCAT44(DAT_0059bd08_4,iVar11 - DAT_0059bc00);
      _DAT_0059bd18 = (double)CONCAT44(DAT_0059bd18_4,iVar20 - DAT_0059bc08);
      fVar23 = (float10)(iVar11 - DAT_0059bc00);
      fVar24 = (float10)local_8;
      in_ST0 = (float10)_DAT_0059bd18 - (float10)_DAT_004faf18;
      ...
      do {
        ...
        iVar11 = DAT_0059bc08;
        iVar20 = DAT_0059bd18 + DAT_0059bc08 + DAT_0059bc08;
        iVar18 = DAT_0059bd08 + DAT_0059bc00 + DAT_0059bc00;
        uVar16 = iVar20 >> 0x10 & DAT_0059bcb0;
        *puVar13 = (&DAT_0061b2a0)
                   [CONCAT31((int3)((ulonglong)_DAT_0059bc50 >> 8),
                             *(undefined1 *)
                              ((&DAT_006439d8)[DAT_0059bd18 + DAT_0059bc08 >> 0x10 & DAT_0059bcb0] +
                              (DAT_0059bd08 + DAT_0059bc00 >> 0x10 & DAT_0059bc38)))];
        ...
        _DAT_0059bd08 = (double)CONCAT44(DAT_0059bd08_4,iVar18);
        _DAT_0059bd18 = (double)CONCAT44(DAT_0059bd18_4,iVar20);
        iVar15 = iVar15 + -1;
        fVar22 = fVar28;
        fVar28 = fVar25;
