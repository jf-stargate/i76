  ...
  if (0 < (int)param_1[2]) {
    ...
    do {
      ...
      if (((iVar4 == 0) && (*(int *)(param_1[1] + iVar8) == param_2)) &&
        ...
        local_8 = param_2;
        _DAT_005dabbc = 0;
        strncpy(&g_vehicle_resource_name_scratch,(char *)&local_8,8);
        iVar7 = _stricmp(&g_vehicle_resource_name_scratch,s_null_004c3280);
        if (iVar7 != 0) {
          uVar1 = 0;
          do {
            uVar5 = uVar1;
            (&g_vehicle_resource_name_scratch)[uVar5] =
                 (&g_vehicle_resource_name_scratch)[uVar5] & 0x7f;
            uVar1 = uVar5 + 1;
          } while (uVar5 + 1 < 8);
