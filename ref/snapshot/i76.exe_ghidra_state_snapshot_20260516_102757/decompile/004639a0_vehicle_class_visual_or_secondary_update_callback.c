/*
 * Program: i76.exe
 * Function: vehicle_class_visual_or_secondary_update_callback
 * Entry: 004639a0
 * Signature: undefined __cdecl vehicle_class_visual_or_secondary_update_callback(LPVOID param_1)
 */
...
void __cdecl vehicle_class_visual_or_secondary_update_callback(LPVOID param_1)

{
  ...
  undefined4 *puVar3;
                    ...
                    /* I76 semantic baseline: vehicle_class_visual_or_secondary_update_callback
                       Vehicle class secondary/visual callback candidate. */
