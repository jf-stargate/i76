...

{
  ...
  if (pFVar3 != (FILE *)0x0) {
    fread(&DAT_00654b40,1,0x60,pFVar3);
    fclose(pFVar3);
  }
  if ((&DAT_004f9e08)[(_g_display_mode_variant_index & 0xff) * 7] == 0) {
    ...
    do {
      if (*piVar4 == 1) {
        _g_display_mode_variant_index = CONCAT31(_DAT_00654b81,cVar5);
        break;
      }
      piVar4 = piVar4 + 7;
      cVar5 = cVar5 + '\x01';
  ...
  if ((CONCAT31(extraout_var,bVar1) != 0) || (DAT_00504be8 != 0)) {
  ...
  if ((DAT_004fcf58 != 0) &&
    ...
    fwrite(&DAT_00654b40,1,0x60,pFVar3);
    fclose(pFVar3);
  }
