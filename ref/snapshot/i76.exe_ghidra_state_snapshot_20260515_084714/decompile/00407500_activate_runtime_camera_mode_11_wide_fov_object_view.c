/*
 * Program: i76.exe
 * Function: activate_runtime_camera_mode_11_wide_fov_object_view
 * Entry: 00407500
 * Signature: undefined __cdecl activate_runtime_camera_mode_11_wide_fov_object_view(int * param_1)
 */


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* cgpt rename v5 runtime camera cluster: Runtime camera mode table id 0x11; initializes
   object-relative view with a wider 2.0943952 rad FOV and callback LAB_00407680. */

void __cdecl activate_runtime_camera_mode_11_wide_fov_object_view(int *param_1)

{
  ...
  puVar3 = (undefined4 *)
           software_raster_command_context_helper_00472220
                     (local_1d8,DAT_004c276c,2.0943952,DAT_004c2760,DAT_004c2740,DAT_004c2764);
  puVar6 = &DAT_004c2730;
  ...
  DAT_004c2928 = 0;
  DAT_004c292c = 0;
  g_runtime_display_mode_change_callback = &LAB_00407680;
  return;
}
