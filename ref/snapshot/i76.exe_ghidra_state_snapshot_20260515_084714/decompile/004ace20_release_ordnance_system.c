/*
 * Program: i76.exe
 * Function: release_ordnance_system
 * Entry: 004ace20
 * Signature: bool __cdecl release_ordnance_system(int param_1, float param_2)
 */
...
bool __cdecl release_ordnance_system(int param_1,float param_2)

{
  ...
  if (((_DAT_004bec48 <= param_2) && (param_2 <= _DAT_004bec4c)) &&
    ...
    local_9c = (local_9c - local_ac) * param_2 + local_ac;
  }
  ...
  local_b4 = *(float *)(param_1 + 0x30) * local_9c + fVar2 + *(float *)(param_1 + 0x18) * local_b4;
  effect_target_list_scan_context_helper_004383a0(&local_d8,&local_b4,local_c0,param_2);
  fVar2 = *(float *)(param_1 + 0x1c) * local_b0;
  fVar1 = *(float *)(param_1 + 0x20) * local_ac;
  ...
  local_ac = *(float *)(param_1 + 0x38) * local_ac + *(float *)(param_1 + 0x30) * local_b4 + fVar3;
  iVar7 = 0;
  local_f0[0] = 0;
  local_b4 = fVar1 + fVar2 + *pfVar9 * local_b4;
  for (; 0 < local_98; local_98 = local_98 + -1) {
    ...
    iVar5 = scan_effect_targets_for_collision_response_b
                      (param_1,iVar5,&local_d8,local_f0,&local_104);
    if (iVar5 != 0) {
      iVar7 = 1;
    }
  }
  ...
  iVar5 = local_fc;
  local_110 = local_d8 - local_e4;
  local_10c = local_d4 - local_e0;
  local_108 = local_d0 - local_dc;
  *(float *)(local_fc + 0x40) =
       SQRT(local_108 * local_108 + local_10c * local_10c + local_110 * local_110) +
       *(float *)(local_fc + 0x40);
  if (iVar7 == 0) {
    pfVar6 = (float *)zone_satellite_map_context_helper_00494880(&local_d8,&local_110,local_7c);
    ...
    *local_100 = local_b4;
    ...
    if (SQRT(local_108 * local_108 + local_10c * local_10c + local_110 * local_110) <= _DAT_004bec5c
       ) {
    ...
    *local_100 = 0.0;
    local_100[1] = 0.0;
    local_100[2] = 0.0;
    spawn_mission_vehicle_effect_by_slot(param_1,&local_d8,local_f0[0],local_104);
    mission_vehicle_effect_spawn_context_helper_004a9090(param_1);
  }
