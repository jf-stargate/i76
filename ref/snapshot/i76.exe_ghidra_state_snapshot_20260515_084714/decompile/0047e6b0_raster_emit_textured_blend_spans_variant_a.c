/*
 * Program: i76.exe
 * Function: raster_emit_textured_blend_spans_variant_a
 * Entry: 0047e6b0
 * Signature: undefined __cdecl raster_emit_textured_blend_spans_variant_a(int * param_1, int * param_2)
 */
...
/* [cgpt i76.exe geo raster span family renames v38; confidence=medium] Affine textured span
   callback variant using destination/source palette blend table. */

void __cdecl raster_emit_textured_blend_spans_variant_a(int *param_1,int *param_2)

{
  ...
  *piVar5 = param_1[10];
  ...
  while (puVar12 != (uint *)(piVar5 + 1)) {
    ...
    _DAT_0059bca8 = (double)(local_8 + (float)_DAT_004faf18);
    _DAT_0059bbd0 = (double)(local_14 + (float)_DAT_004faf18);
    ...
    _DAT_0059bca8 = (double)CONCAT44(DAT_0059bca8_4,iVar17);
    _DAT_0059bbd0 = (double)CONCAT44(DAT_0059bbd0_4,iVar11);
    ...
    if (-1 < local_18 + -1) {
      do {
        ...
        iVar17 = DAT_0059bc08;
        iVar11 = DAT_0059bbd0 + DAT_0059bc08 + DAT_0059bc08;
        iVar18 = DAT_0059bca8 + DAT_0059bc00 + DAT_0059bc00;
        uVar15 = iVar11 >> 0x10 & DAT_0059bcb0;
        *local_10 = (&DAT_00609fa0)
                    [CONCAT11(*(undefined1 *)
                               ((&DAT_006439d8)[DAT_0059bbd0 + DAT_0059bc08 >> 0x10 & DAT_0059bcb0]
                               + (DAT_0059bca8 + DAT_0059bc00 >> 0x10 & DAT_0059bc38)),*local_10)];
        iVar11 = iVar11 + iVar17;
        iVar19 = iVar18 + DAT_0059bc00;
        uVar14 = iVar11 >> 0x10 & DAT_0059bcb0;
        iVar17 = DAT_0059bc08;
        local_10[1] = (&DAT_00609fa0)
                      [CONCAT11(*(undefined1 *)
                                 ((&DAT_006439d8)[uVar15] + (iVar18 >> 0x10 & DAT_0059bc38)),
                                local_10[1])];
        iVar11 = iVar11 + iVar17;
        iVar18 = iVar19 + DAT_0059bc00;
        uVar15 = iVar11 >> 0x10 & DAT_0059bcb0;
        iVar17 = DAT_0059bc08;
        local_10[2] = (&DAT_00609fa0)
                      [CONCAT11(*(undefined1 *)
                                 ((&DAT_006439d8)[uVar14] + (iVar19 >> 0x10 & DAT_0059bc38)),
                                local_10[2])];
        iVar11 = iVar11 + iVar17;
        iVar19 = iVar18 + DAT_0059bc00;
        uVar14 = iVar11 >> 0x10 & DAT_0059bcb0;
        iVar17 = DAT_0059bc08;
        local_10[3] = (&DAT_00609fa0)
                      [CONCAT11(*(undefined1 *)
                                 ((&DAT_006439d8)[uVar15] + (iVar18 >> 0x10 & DAT_0059bc38)),
                                local_10[3])];
        iVar11 = iVar11 + iVar17;
        ...
        local_10[0xb] =
             (&DAT_00609fa0)
             [CONCAT11(*(undefined1 *)((&DAT_006439d8)[uVar16] + (iVar18 >> 0x10 & DAT_0059bc38)),
                       local_10[0xb])];
        iVar11 = iVar11 + iVar17;
        iVar18 = iVar19 + DAT_0059bc00;
        uVar14 = iVar11 >> 0x10 & DAT_0059bcb0;
        ...
        local_10[0xc] =
             (&DAT_00609fa0)
             [CONCAT11(*(undefined1 *)((&DAT_006439d8)[uVar15] + (iVar19 >> 0x10 & DAT_0059bc38)),
                       local_10[0xc])];
        iVar11 = iVar11 + iVar17;
        iVar19 = iVar18 + DAT_0059bc00;
        uVar16 = iVar11 >> 0x10 & DAT_0059bcb0;
        ...
        local_10[0xd] =
             (&DAT_00609fa0)
             [CONCAT11(*(undefined1 *)((&DAT_006439d8)[uVar14] + (iVar18 >> 0x10 & DAT_0059bc38)),
                       local_10[0xd])];
        iVar11 = iVar11 + iVar17;
        iVar18 = iVar19 + DAT_0059bc00;
        ...
        local_10[0xe] =
             (&DAT_00609fa0)
             [CONCAT11(*(undefined1 *)((&DAT_006439d8)[uVar16] + (iVar19 >> 0x10 & DAT_0059bc38)),
                       local_10[0xe])];
        local_10[0xf] = (&DAT_00609fa0)[CONCAT11(*(undefined1 *)(iVar17 + uVar15),local_10[0xf])];
        _DAT_0059bca8 = (double)CONCAT44(DAT_0059bca8_4,iVar18);
        _DAT_0059bbd0 = (double)CONCAT44(DAT_0059bbd0_4,iVar11);
        local_18 = local_18 + -1;
