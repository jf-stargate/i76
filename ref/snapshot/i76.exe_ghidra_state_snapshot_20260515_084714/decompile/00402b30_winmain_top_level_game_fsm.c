...

{
  ...
  *(undefined4 *)StrLookup_Global_Object_exref = uVar8;
  ...
  if (DAT_00504be8 != 0) {
    parse_driver_selection_arg(s_RASTER_004c2628,&DAT_005dd340,1);
    load_raster_plugin_and_resolve_exports(&DAT_005dd340);
  }
  if (param_2 == 0) {
    local_970.style = 3;
  ...
  DAT_005dd320 = virtual_alloc_reserved_commit_region(0x1a5e0,0x40000);
  if (DAT_005dd320 == (LPVOID)0x0) {
    report_chunk_parse_error();
  }
  DAT_005dd2ec = (int)DAT_005dd320 + 54000;
...
LAB_0040320b:
  do {
    if ((char)local_9d4 == -1) {
      ...
      system_cutscene_memory_context_helper_00498a00(DAT_005dd320);
...
LAB_004034cf:
    ...
    if (iVar9 != 0) {
      ...
      do {
        get_tick_count_wrapper_c();
        iVar9 = wait_for_multiplayer_mission_start_sync();
      } while (iVar9 == 0);
      fVar22 = get_multiplayer_or_runtime_seconds();
    ...
    if (iVar9 == 0) {
      ...
      input_device_binding_input_action_state_helper_0044dcc0();
      shutdown_audio_runtime_directsound_cd();
      if ((DAT_005dcfa0 != 0) &&
    ...
    while (g_game_flow_state == 5) {
      ...
      get_tick_count_wrapper_c();
      update_input_bindings_and_pending_action_code();
...
LAB_00403bc6:
          ...
          dispatch_world_object_frame_begin_callbacks();
          if (DAT_00504be8 == 0) {
            iVar9 = is_network_or_trip_runtime_mode();
          ...
          dispatch_world_object_frame_end_callbacks();
...
LAB_00403fee:
          ...
          if ((DAT_00504bf0 != 0) &&
             (bVar2 = get_global_heap_handle(), CONCAT31(extraout_var_11,bVar2) != 0)) {
            DAT_00504bf0 = 0;
