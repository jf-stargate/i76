/*
 * Program: i76.exe
 * Function: update_vehicle_recovery_or_autopilot_state
 * Entry: 0043d070
 * Signature: undefined __cdecl update_vehicle_recovery_or_autopilot_state(float param_1)
 */
...
void __cdecl update_vehicle_recovery_or_autopilot_state(float param_1)
