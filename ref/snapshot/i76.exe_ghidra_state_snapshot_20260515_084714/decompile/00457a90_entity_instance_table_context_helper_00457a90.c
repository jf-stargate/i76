...

{
          ...
          for (iVar9 = *(int *)(iVar9 + 100); iVar9 != 0; iVar9 = *(int *)(iVar9 + 0x60)) {
            ...
            if ((int)uVar8 < 1) {
              ...
              *(uint *)(iVar9 + 0x14) = *(uint *)(iVar9 + 0x14) & 0xffffffee;
              ...
              terrain_map_context_helper_0048fe10((float)puVar6[10] - (float)puVar6[0xb]);
            }
          }
        }
      }
  ...
  if (0 < param_4) {
    ...
    do {
      ...
      local_8 = local_8 + 3;
      iVar13 = iVar13 + 1;
      terrain_map_context_helper_0048fe10((float)puVar6[10] - (float)piVar12[4]);
  ...
  if (0 < param_5) {
    ...
    do {
      ...
      fVar2 = *pfVar7;
      puVar6[0xc] = iVar9;
      terrain_map_context_helper_0048fe10(fVar2 - (float)piVar12[4]);
      iVar13 = iVar13 + 1;
      pfVar7 = pfVar7 + 3;
