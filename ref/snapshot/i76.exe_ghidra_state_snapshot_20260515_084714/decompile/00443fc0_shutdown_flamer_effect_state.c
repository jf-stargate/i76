  ...
  do {
    ...
    if ((piVar22[1] != 0) && (piVar22[6] != piVar22[7])) {
      ...
      transform_vec3_array_by_matrix
                (DAT_005dd320,(float *)(piVar22 + 0x23),iVar18 * 3,(float *)(param_1 + 0x40));
      iVar18 = piVar22[10];
      iVar19 = piVar22[0xd];
      iVar2 = piVar22[0xb];
      uVar1 = iVar18 + 1;
      ...
      if (iVar24 != iVar15) {
        do {
          ...
          iVar6 = iVar24 * 3;
          iVar7 = iVar15 * 3;
          pfVar14 = DAT_005dd320 + iVar24 * 9;
          local_d0 = (iVar7 + 2) * 0xc;
          local_bc = iVar15 * 0x24;
          local_b0 = (DAT_005dd320[(iVar7 + 2) * 3] + *pfVar14) * _DAT_004bd344;
          local_ac = (DAT_005dd320[iVar15 * 9 + 7] + pfVar14[1]) * _DAT_004bd344;
          local_a8 = (pfVar14[2] + DAT_005dd320[iVar15 * 9 + 8]) * _DAT_004bd344;
          local_f4 = iVar15;
          ...
          if (iVar16 < 1) {
            ...
            do {
              puVar17 = terrain_map_context_helper_00490590();
              puVar17[3] = 8;
              *puVar17 = 4;
              uVar4 = (&DAT_004f2090)[piVar22[9] * 0x39];
              puVar17[1] = local_1d4;
              puVar17[2] = uVar4;
              pfVar14 = DAT_005dd320 + (iVar6 + piVar25[-1]) * 3;
              puVar17[7] = *pfVar14;
              puVar17[8] = pfVar14[1];
              puVar17[9] = pfVar14[2];
              ...
              pfVar14 = DAT_005dd320 + (iVar7 + piVar25[-1]) * 3;
              ...
              pfVar14 = DAT_005dd320 + (iVar7 + *piVar25) * 3;
              ...
              pfVar14 = DAT_005dd320 + (iVar6 + *piVar25) * 3;
              puVar17[0xd] = *pfVar14;
              ...
              puVar17[4] = fVar23;
              terrain_map_context_helper_0048fe10(fVar23);
              puVar17 = terrain_map_context_helper_00490590();
              puVar17[3] = 8;
              *puVar17 = 4;
            ...
            *puVar17 = 3;
            ...
            puVar17[1] = uVar4;
            puVar17[2] = uVar5;
            puVar21 = (undefined4 *)((int)DAT_005dd320 + local_bc);
            puVar17[7] = *puVar21;
            puVar17[8] = puVar21[1];
            puVar17[9] = puVar21[2];
            ...
            pfVar14 = DAT_005dd320 + (iVar7 + 1) * 3;
            puVar17[0xd] = *pfVar14;
            puVar17[0xe] = pfVar14[1];
            puVar17[0xf] = pfVar14[2];
            puVar17[0x10] = DAT_004f1f5c;
            puVar17[0x11] = DAT_004f1f60;
            puVar17[0x12] = DAT_004f1f64;
            puVar21 = (undefined4 *)((int)DAT_005dd320 + local_d0);
