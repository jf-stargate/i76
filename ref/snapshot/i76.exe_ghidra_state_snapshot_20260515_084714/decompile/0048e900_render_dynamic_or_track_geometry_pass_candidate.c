        ...
        if (0 < iVar18) {
          do {
            ...
            if ((local_104 <= _DAT_004be7b8) &&
               ...
               pfVar12 = DAT_005dd320, iVar10 < 1)) {
              iVar10 = local_150 + DAT_004fa91c;
              local_110 = local_150 + DAT_004fa924;
              local_118 = DAT_005dd320[iVar10 * 3 + 2] - DAT_005dd320[iVar14 * 3 + 2];
              local_120[0] = DAT_005dd320[iVar10 * 3] - DAT_005dd320[iVar14 * 3];
              local_12c = local_118 * (DAT_005dd320[iVar17 * 3 + 1] - DAT_005dd320[iVar14 * 3 + 1])
                          - (DAT_005dd320[iVar10 * 3 + 1] - DAT_005dd320[iVar14 * 3 + 1]) *
                            (DAT_005dd320[iVar17 * 3 + 2] - DAT_005dd320[iVar14 * 3 + 2]);
              local_124 = (DAT_005dd320[iVar10 * 3 + 1] - DAT_005dd320[iVar14 * 3 + 1]) *
                          (DAT_005dd320[iVar17 * 3] - DAT_005dd320[iVar14 * 3]) -
                          local_120[0] *
                          (DAT_005dd320[iVar17 * 3 + 1] - DAT_005dd320[iVar14 * 3 + 1]);
              local_128 = local_120[0] *
                          (DAT_005dd320[iVar17 * 3 + 2] - DAT_005dd320[iVar14 * 3 + 2]) -
                          local_118 * (DAT_005dd320[iVar17 * 3] - DAT_005dd320[iVar14 * 3]);
              if (_DAT_004be7b0 <=
                  DAT_005dd320[iVar14 * 3 + 1] * local_128 +
                  DAT_005dd320[iVar14 * 3 + 2] * local_124 + local_12c * DAT_005dd320[iVar14 * 3]) {
                puVar11 = terrain_map_context_helper_00490590();
                iVar15 = 10;
                puVar11[3] = 1;
                *puVar11 = 4;
                ...
                fVar2 = DAT_005dd320[iVar14 * 3 + 2] * _DAT_00643600 + _DAT_006435fc;
                ...
                fVar2 = DAT_005dd320[iVar10 * 3 + 2] * _DAT_00643600 + _DAT_006435fc;
                if (fVar2 < _DAT_004be7c0) {
                  fVar2 = _DAT_004be7c0;
                }
                if (_DAT_004be7c4 < fVar2) {
                ...
                fVar2 = DAT_005dd320[iVar17 * 3 + 2] * _DAT_00643600 + _DAT_006435fc;
                if (fVar2 < _DAT_004be7c0) {
                  fVar2 = _DAT_004be7c0;
                }
                if (_DAT_004be7c4 < fVar2) {
                ...
                puVar11[0x18] = fVar2;
                pfVar12 = DAT_005dd320 + local_110 * 3;
                ...
                fVar2 = DAT_005dd320[local_110 * 3 + 2] * _DAT_00643600 + _DAT_006435fc;
                if (fVar2 < _DAT_004be7c0) {
                  fVar2 = _DAT_004be7c0;
                }
                if (_DAT_004be7c4 < fVar2) {
                ...
                puVar11[4] = fVar2;
                terrain_map_context_helper_0048fe10(fVar2);
                pfVar12 = DAT_005dd320;
              }
            }
      ...
      if (cVar21 == '\0') {
        ...
        if ((((iVar9 < 1) &&
          ...
          transform_vec3_array_by_matrix
                    (DAT_005dd320,*(float **)(iVar9 + 0xc),*(int *)(iVar9 + 4),local_d8);
...
LAB_0048f17e:
              ...
              if (0 < iVar17) {
                ...
                do {
                  ...
                  fVar1 = DAT_005dd320[iVar14 * 3 + 2] * _DAT_00643600 + _DAT_006435fc;
              ...
              puVar11[4] = local_154;
              terrain_map_context_helper_0048fe10(local_154);
            }
          }
        }
      }
