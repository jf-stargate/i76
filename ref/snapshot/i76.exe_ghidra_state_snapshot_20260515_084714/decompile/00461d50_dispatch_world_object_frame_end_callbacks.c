/*
 * Program: i76.exe
 * Function: dispatch_world_object_frame_end_callbacks
 * Entry: 00461d50
 * Signature: undefined __stdcall dispatch_world_object_frame_end_callbacks(void)
 */
...
void dispatch_world_object_frame_end_callbacks(void)
