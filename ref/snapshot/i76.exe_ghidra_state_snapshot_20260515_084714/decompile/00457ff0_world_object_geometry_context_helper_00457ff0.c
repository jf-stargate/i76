...
LAB_00458360:
          ...
          for (iVar8 = *(int *)(iVar8 + 100); iVar8 != 0; iVar8 = *(int *)(iVar8 + 0x60)) {
            ...
            if ((int)uVar6 < 1) {
              puVar4 = terrain_map_context_helper_00490590();
              *(uint *)(iVar8 + 0x14) = *(uint *)(iVar8 + 0x14) & 0xffffffee;
              ...
              terrain_map_context_helper_0048fe10((float)puVar4[10] - (float)puVar4[0xb]);
            }
LAB_00458202:
          }
        }
  ...
  if (0 < iStack0000000c) {
    ...
    do {
      ...
      if ((DAT_00654b86 != '\0') && (*pfVar5 < _DAT_004bdfa0)) {
        ...
        terrain_map_context_helper_0048fe10(*pfVar5 - (float)piVar12[4]);
      }
      local_8 = local_8 + 1;
      pfVar5 = pfVar5 + 3;
      iVar11 = iVar11 + -1;
  ...
  if (0 < iStack0000000c) {
    ...
    do {
      ...
      puVar4[10] = local_8[2];
      puVar4[0xb] = piVar12[4];
      terrain_map_context_helper_0048fe10((float)puVar4[10] - (float)piVar12[4]);
      iVar11 = iVar11 + 1;
      local_8 = local_8 + 3;
