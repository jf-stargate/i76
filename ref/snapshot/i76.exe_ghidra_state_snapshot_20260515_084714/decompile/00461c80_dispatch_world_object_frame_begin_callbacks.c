/*
 * Program: i76.exe
 * Function: dispatch_world_object_frame_begin_callbacks
 * Entry: 00461c80
 * Signature: undefined __stdcall dispatch_world_object_frame_begin_callbacks(void)
 */


/* [cgpt i76.exe runtime loop refinement v23; confidence=HIGH] Per-frame world-object callback pass
   before major simulation update. */

void dispatch_world_object_frame_begin_callbacks(void)

{
  ...
  do {
    while( true ) {
      ...
      do {
        if (*piVar5 == iVar6) goto LAB_00461d26;
        piVar5 = piVar5 + 0xd;
        iVar4 = iVar4 + 1;
...
LAB_00461d26:
      piVar5 = piVar1;
      if ((code *)(&DAT_004f76ec)[iVar4 * 0xd] != (code *)0x0) {
        (*(code *)(&DAT_004f76ec)[iVar4 * 0xd])(pvVar3);
      }
    }
