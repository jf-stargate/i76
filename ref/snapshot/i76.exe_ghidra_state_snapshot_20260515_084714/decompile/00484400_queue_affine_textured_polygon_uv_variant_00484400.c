/*
 * Program: i76.exe
 * Function: queue_affine_textured_polygon_uv_variant_00484400
 * Entry: 00484400
 * Signature: undefined __cdecl queue_affine_textured_polygon_uv_variant_00484400(int param_1, float * param_2, int param_3, undefined4 param_4)
 */


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* [cgpt i76.exe GEO raster span renames v37; confidence=medium] Affine textured draw-table variant
   from raster draw table. */

void __cdecl
queue_affine_textured_polygon_uv_variant_00484400
    ...
    if (DAT_004f9d80 != (void *)0x0) {
      puVar5 = (undefined4 *)
               initialize_raster_command_record
                         (DAT_004f9d80,param_4,2,raster_emit_span_callback_mode_00483cc0);
    }
    local_4 = 0xffffffff;
