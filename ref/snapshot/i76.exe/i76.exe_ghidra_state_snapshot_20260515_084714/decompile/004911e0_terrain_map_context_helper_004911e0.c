/*
 * Program: i76.exe
 * Function: terrain_map_context_helper_004911e0
 * Entry: 004911e0
 * Signature: undefined __cdecl terrain_map_context_helper_004911e0(undefined2 * param_1, undefined2 * param_2, short * param_3, short * param_4)
 */
...
void __cdecl
terrain_map_context_helper_004911e0
...

{
  ...
  do {
    pfVar2 = (float *)(DAT_005dd320 + *param_3 * 0xc);
    iVar20 = DAT_005dd320 + param_4[1] * 0xc;
    iVar12 = ftol();
    ...
    iVar21 = iVar12 >> 1;
    fVar8 = (float)iVar21;
    iVar17 = DAT_005dd320 + *param_4 * 0xc;
    fVar7 = fVar8 + fVar8;
    iVar3 = DAT_005dd320 + param_3[1] * 0xc;
    if (iVar21 < 0x20) {
      ...
      if (fVar7 * fVar7 * _DAT_006442c8 < fVar8) goto LAB_004917bc;
      if (fVar7 * fVar7 <= fVar8 + fVar8) {
        fVar8 = (float)((uint)fVar8 & 0xff800000) * _DAT_006442cc;
        iVar12 = iVar12 >> 2;
        iVar13 = ftol();
        ...
        uVar11 = terrain_map_context_helper_00493160(iVar13,iVar14);
        if (ABS((fVar9 - (float)CONCAT22(extraout_var,uVar11)) * fVar7) <= fVar8) {
          if (iVar21 == 1) {
LAB_00491541:
            if (fVar7 <= _DAT_004be7f8) {
LAB_004917bc:
              psVar15 = terrain_map_context_helper_00491810(param_1,param_2,param_3,param_4);
              if (DAT_0059c560 == (short *)0x0) {
                DAT_0059c560 = psVar15;
                DAT_0059c574 = psVar15;
                return;
              }
              *(short **)((int)DAT_0059c574 + 8) = psVar15;
              DAT_0059c574 = psVar15;
              return;
            }
            ...
            if ((((0x3fff < iVar12) || (iVar12 < 0)) || (0x3fff < uVar23)) ||
               (iVar12 = (&DAT_00644380)[iVar12] + uVar23 * 2, iVar20 < 0)) goto LAB_004917bc;
            ...
            uVar11 = terrain_map_context_helper_00493160(iVar13 - iVar12,iVar14 + iVar12);
    ...
    terrain_map_context_helper_004918f0(param_1);
    terrain_map_context_helper_004918f0(param_2);
    terrain_map_context_helper_004918f0(param_3);
    terrain_map_context_helper_004918f0(param_4);
    puVar10 = DAT_00654380;
    ...
    *(undefined4 *)(puVar10 + 4) = 0;
    ...
    terrain_map_context_helper_004918f0(puVar10);
    psVar15 = (short *)terrain_map_context_helper_004918b0
                                 (*(undefined2 *)(*(int *)(param_1 + 2) + 2),
                                  *(undefined2 *)(*(int *)(puVar10 + 2) + 2));
    psVar16 = (short *)terrain_map_context_helper_004918b0
                                 (*(undefined2 *)(*(int *)(puVar10 + 2) + 2),
