...

{
  ...
  do {
    fVar15 = get_multiplayer_or_runtime_seconds();
    ...
    if (piVar13[6] != piVar13[7]) {
      transform_vec3_array_by_matrix
                (DAT_005dd320,(float *)(piVar13 + 0x16),0x45,(float *)(param_1 + 0x40));
      iVar3 = piVar13[0xb];
      iVar4 = piVar13[0xc];
      iVar5 = piVar13[10];
      piVar13[10] = 0;
      ...
      if (piVar13[6] != iVar11) {
        do {
          ...
          if (iVar11 != 0) {
            iVar7 = iVar6 * 3;
            pfVar1 = DAT_005dd320 + iVar8 * 9;
            local_c = (DAT_005dd320[(iVar7 + 2) * 3] + *pfVar1) * _DAT_004bd2cc;
            local_8 = (DAT_005dd320[iVar6 * 9 + 7] + pfVar1[1]) * _DAT_004bd2cc;
            local_4 = (pfVar1[2] + DAT_005dd320[iVar6 * 9 + 8]) * _DAT_004bd2cc;
            iVar9 = software_raster_queue_context_helper_00472c10(param_1,&local_c,12.0);
            if (iVar9 < 1) {
              piVar14 = &DAT_004f1ce0;
              do {
                puVar10 = terrain_map_context_helper_00490590();
                puVar10[3] = 8;
                *puVar10 = 4;
                puVar10[2] = (&DAT_004f1d34)[piVar13[9] * 0x10];
                puVar10[1] = iVar11;
                pfVar1 = DAT_005dd320 + (iVar8 * 3 + *piVar14) * 3;
                puVar10[7] = *pfVar1;
                puVar10[8] = pfVar1[1];
                puVar10[9] = pfVar1[2];
                ...
                pfVar1 = DAT_005dd320 + (iVar8 * 3 + piVar14[1]) * 3;
                puVar10[0xd] = *pfVar1;
                ...
                pfVar1 = DAT_005dd320 + (iVar7 + piVar14[1]) * 3;
                puVar10[0x13] = *pfVar1;
                ...
                pfVar1 = DAT_005dd320 + (iVar7 + *piVar14) * 3;
                puVar10[0x19] = *pfVar1;
