/*
 * Program: i76.exe
 * Function: apply_player_vehicle_damage_context_and_death
 * Entry: 00463a80
 * Signature: undefined4 __cdecl apply_player_vehicle_damage_context_and_death(int param_1, int * param_2, float * param_3)
 */
...
undefined4 __cdecl
apply_player_vehicle_damage_context_and_death(int param_1,int *param_2,float *param_3)
