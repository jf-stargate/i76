/*
 * Program: i76.exe
 * Function: queue_affine_textured_polygon_uv
 * Entry: 0047da90
 * Signature: undefined __cdecl queue_affine_textured_polygon_uv(int param_1, float * param_2, int param_3, undefined4 param_4)
 */


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* [cgpt i76.exe geo raster span family renames v38; confidence=high] Queues affine textured polygon
   command with U/V gradients and no light gradient. */

void __cdecl
queue_affine_textured_polygon_uv(int param_1,float *param_2,int param_3,undefined4 param_4)

{
  ...
  if (0 < param_3) {
    ...
    if (DAT_004f9d80 != (void *)0x0) {
      puVar5 = (undefined4 *)
               initialize_raster_command_record
                         (DAT_004f9d80,param_4,0,raster_emit_affine_textured_spans);
    }
    local_4 = 0xffffffff;
    ...
    if (iVar4 != 0) {
      ...
      puVar5[4] = fVar3 * local_30 + fVar1 * local_24 + fVar2 * local_18;
      puVar5[0x12] = fVar3 * local_2c + fVar1 * local_20 + fVar2 * local_14;
      puVar5[0x13] = fVar3 * local_28 + fVar1 * local_1c + fVar2 * local_10;
    }
  }
  ExceptionList = local_c;
  return;
