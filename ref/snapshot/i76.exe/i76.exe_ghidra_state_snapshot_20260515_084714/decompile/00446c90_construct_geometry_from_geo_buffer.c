...
/* [cgpt i76.exe GEO lighting/render renames v33; confidence=high] Constructs runtime geometry from
   decoded GEO buffer: positions, normal/secondary table, section records, texture slots, centroid,
   and entries. */
...

{
  ...
  lpMem_00 = HeapAlloc(g_geometry_heap,0,SVar9);
  do {
    if (lpMem_00 != (undefined4 *)0x0) {
      SVar9 = HeapSize(g_geometry_heap,0,lpMem_00);
      DAT_00608e5c = DAT_00608e5c - SVar9;
LAB_00446e4d:
      if (lpMem_00 == (undefined4 *)0x0) {
        return (undefined4 *)0x0;
      }
          ...
          if (*_Str == '\0') {
            *(undefined1 *)(iVar10 + 0x20) = 0;
            ...
            if (pcVar11 == (char *)0x0) {
              ...
              if (iVar12 == 0) {
                if (g_last_geometry_texture_uses_tmt_extension == 0) {
                ...
                _DAT_00531b34 = local_4;
                g_last_geometry_texture_uses_tmt_extension = 1;
                *puVar13 = DAT_004f25f0;
                *(undefined1 *)((int)&local_10 + uVar17 + 3) = DAT_004f25f4;
                ...
                if (CONCAT31(extraout_var,bVar7) == 0) {
                  *puVar13 = DAT_004f25e8;
                  *(undefined1 *)((int)&local_10 + uVar17 + 3) = DAT_004f25ec;
                  g_last_geometry_texture_uses_tmt_extension = 0;
                }
              }
    ...
    if (g_geometry_purge_list_head == (uint *)0x0) {
      report_chunk_parse_error();
      goto LAB_00446e4d;
    }
    uVar17 = (g_geometry_purge_list_head[3] * 0x6cd + 0xaab) % 0x7ed;
    puVar5 = &g_geometry_cache_by_handle + uVar17;
    for (puVar3 = (uint *)(&g_geometry_cache_by_handle)[uVar17];
        puVar3 != g_geometry_purge_list_head; puVar3 = (uint *)puVar3[4]) {
      puVar5 = puVar3 + 4;
    }
    *puVar5 = puVar3[4];
    uVar17 = *puVar3;
    ...
    for (puVar3 = (uint *)(&g_geometry_cache_by_8char_name)[uVar17];
        puVar3 != g_geometry_purge_list_head; puVar3 = (uint *)puVar3[5]) {
      puVar5 = puVar3 + 5;
    }
    *puVar5 = puVar3[5];
    ...
    SVar8 = HeapSize(g_geometry_heap,0,lpMem);
    DAT_00608e5c = DAT_00608e5c + SVar8;
