/*
 * Program: i76.exe
 * Function: raster_emit_span_callback_mode_0048a870
 * Entry: 0048a870
 * Signature: undefined __cdecl raster_emit_span_callback_mode_0048a870(int * param_1, int * param_2)
 */
...
void __cdecl raster_emit_span_callback_mode_0048a870(int *param_1,int *param_2)

{
  ...
  *piVar6 = param_1[10];
  ...
  while (puVar15 != (uint *)(piVar6 + 1)) {
    ...
    _DAT_0059bbf8 = (double)(fVar9 * local_c + (float)_DAT_004faf18);
    _DAT_0059bd48 = (double)(fVar9 * local_10 + (float)_DAT_004faf18);
    local_c = fVar7 * local_14 + local_c;
    local_10 = fVar7 * local_1c + local_10;
    param_2 = (int *)(fVar7 * local_18 + fVar8);
    _DAT_0059bc00 =
         (double)(((_DAT_004be778 / (float)param_2) * local_c - (float)DAT_0059bbf8) *
                  *(float *)(&DAT_004f9d38 + uVar23 * 4) + (float)_DAT_004faf18);
    _DAT_0059bc08 =
         (double)(((_DAT_004be778 / (float)param_2) * local_10 - (float)DAT_0059bd48) *
                  *(float *)(&DAT_004f9d38 + uVar23 * 4) + (float)_DAT_004faf18);
    if (0 < (int)uVar19 >> 4) {
    ...
    _DAT_0059bbf8 = (double)CONCAT44(DAT_0059bbf8_4,iVar12);
    _DAT_0059bd48 = (double)CONCAT44(DAT_0059bd48_4,iVar14);
    iVar20 = ((int)uVar19 >> 4) + -1;
    if (-1 < iVar20) {
      _DAT_0059bbf8 = (double)CONCAT44(DAT_0059bbf8_4,iVar12 - DAT_0059bc00);
      _DAT_0059bd48 = (double)CONCAT44(DAT_0059bd48_4,iVar14 - DAT_0059bc08);
      fVar24 = (float10)(iVar12 - DAT_0059bc00);
      fVar25 = (float10)local_10;
      fVar26 = (float10)_DAT_0059bd48 - (float10)_DAT_004faf18;
      fVar28 = in_ST0;
      ...
      do {
        ...
        iVar12 = DAT_0059bc08;
        iVar14 = DAT_0059bd48 + DAT_0059bc08 + DAT_0059bc08;
        iVar22 = DAT_0059bbf8 + DAT_0059bc00 + DAT_0059bc00;
        uVar19 = DAT_0059bba0 + DAT_0059bc50;
        uVar10 = (ulonglong)_DAT_0059bc50 >> 8;
        cVar1 = *(char *)((&DAT_006439d8)[DAT_0059bd48 + DAT_0059bc08 >> 0x10 & DAT_0059bcb0] +
                         (DAT_0059bbf8 + DAT_0059bc00 >> 0x10 & DAT_0059bc38));
        ...
        _DAT_0059bbf8 = (double)CONCAT44(DAT_0059bbf8_4,iVar22);
        _DAT_0059bd48 = (double)CONCAT44(DAT_0059bd48_4,iVar21);
        iVar20 = iVar20 + -1;
        fVar28 = fVar31;
        fVar31 = fVar27;
        fVar32 = fVar30;
