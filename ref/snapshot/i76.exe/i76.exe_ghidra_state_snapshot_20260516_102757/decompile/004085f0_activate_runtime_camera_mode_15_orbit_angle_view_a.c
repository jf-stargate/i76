/*
 * Program: i76.exe
 * Function: activate_runtime_camera_mode_15_orbit_angle_view_a
 * Entry: 004085f0
 * Signature: undefined __cdecl activate_runtime_camera_mode_15_orbit_angle_view_a(int * param_1)
 */


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* cgpt rename v5 runtime camera cluster: Runtime camera mode table id 0x15; initializes
   object-relative orbit view with angle constant 0x40278d36 and callback LAB_00407ad0. */

void __cdecl activate_runtime_camera_mode_15_orbit_angle_view_a(int *param_1)
