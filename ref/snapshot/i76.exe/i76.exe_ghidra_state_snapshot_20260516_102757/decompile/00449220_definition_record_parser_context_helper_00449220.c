/*
 * Program: i76.exe
 * Function: definition_record_parser_context_helper_00449220
 * Entry: 00449220
 * Signature: undefined __cdecl definition_record_parser_context_helper_00449220(int * param_1, uint param_2, char * param_3, char * param_4, char * param_5, char * param_6)
 */


/* cgpt label refinement v18: was definition_record_parser_definition_parser_helper_00449220. Remove
...
LAB_004493fc:
  if (((local_ec != (undefined4 *)0x0) && (local_f0 != (undefined4 *)0x0)) &&
    ...
    if ((puVar5 != (uint *)0x0) && (local_88 != 0)) {
      puVar1 = (undefined4 *)local_f0[4];
      puVar2 = (undefined4 *)local_ec[4];
      local_e4 = puVar1;
      iVar9 = ftol();
      ...
      iVar9 = ((int)(puVar5[1] << 3) >> 3) - local_ec[5];
      set_bitmap_surface_clip_rect
                (local_34,(int)puVar10,iVar9 - local_ec[7],local_ec[6] + (int)puVar10,iVar9);
