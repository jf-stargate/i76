...

{
  ...
  if (pFVar1 != (FILE *)0x0) {
    fclose(pFVar1);
    sprintf(&g_resource_error_message,s_File___s__already_exists_00500e50,param_1);
    return 0;
  }
  pFVar1 = fopen(param_1,s_wb_004edf28);
  if (pFVar1 == (FILE *)0x0) {
    sprintf(&g_resource_error_message,s_Could_not_create_file___s__00500e34,param_1);
    return 0;
  }
  local_e2f = 0x46;
  local_e2d = 0x46;
  ...
  sprintf(&g_resource_error_message,s_Error_writing_to_file___s__00500e18,param_1);
  fclose(pFVar1);
  return 0;
}
