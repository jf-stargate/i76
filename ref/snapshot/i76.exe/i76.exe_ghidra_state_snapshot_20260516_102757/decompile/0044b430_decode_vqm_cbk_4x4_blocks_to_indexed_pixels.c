...
/* [cgpt i76.exe GEO mesh/render renames v29; confidence=high] Decodes VQM 4x4 block-compressed
   indexed textures through CBK codebook tiles into an M16-like indexed-pixel buffer. */
