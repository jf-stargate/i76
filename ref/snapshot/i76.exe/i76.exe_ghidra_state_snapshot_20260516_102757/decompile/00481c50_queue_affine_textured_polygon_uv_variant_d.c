/*
 * Program: i76.exe
 * Function: queue_affine_textured_polygon_uv_variant_d
 * Entry: 00481c50
 * Signature: undefined __cdecl queue_affine_textured_polygon_uv_variant_d(int param_1, float * param_2, int param_3, undefined4 param_4)
 */
...
void __cdecl
queue_affine_textured_polygon_uv_variant_d
    ...
    if (DAT_004f9d80 != (void *)0x0) {
      puVar5 = (undefined4 *)
               initialize_raster_command_record
                         (DAT_004f9d80,param_4,2,raster_emit_textured_spans_variant_d);
    }
    local_4 = 0xffffffff;
