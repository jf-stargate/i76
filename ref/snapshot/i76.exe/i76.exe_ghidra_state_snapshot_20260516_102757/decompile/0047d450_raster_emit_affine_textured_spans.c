/*
 * Program: i76.exe
 * Function: raster_emit_affine_textured_spans
 * Entry: 0047d450
 * Signature: undefined __cdecl raster_emit_affine_textured_spans(int * param_1, int * param_2)
 */
...
/* [cgpt i76.exe geo raster span family renames v38; confidence=high] Span callback for affine
   textured spans with U/V interpolation and direct texture sampling. */

void __cdecl raster_emit_affine_textured_spans(int *param_1,int *param_2)

{
  ...
  *piVar5 = param_1[10];
  ...
  while (puVar12 != (uint *)(piVar5 + 1)) {
    ...
    _DAT_0059bb98 = (double)(local_8 + (float)_DAT_004faf18);
    _DAT_0059bcc8 = (double)(local_14 + (float)_DAT_004faf18);
    ...
    _DAT_0059bb98 = (double)CONCAT44(DAT_0059bb98_4,iVar17);
    _DAT_0059bcc8 = (double)CONCAT44(DAT_0059bcc8_4,iVar11);
    ...
    if (-1 < local_18 + -1) {
      do {
        ...
        iVar17 = DAT_0059bc08;
        iVar11 = DAT_0059bcc8 + DAT_0059bc08 + DAT_0059bc08;
        iVar18 = DAT_0059bb98 + DAT_0059bc00 + DAT_0059bc00;
        uVar15 = iVar11 >> 0x10 & DAT_0059bcb0;
        *(undefined1 *)local_10 =
             *(undefined1 *)
              ((&DAT_006439d8)[DAT_0059bcc8 + DAT_0059bc08 >> 0x10 & DAT_0059bcb0] +
              (DAT_0059bb98 + DAT_0059bc00 >> 0x10 & DAT_0059bc38));
        iVar11 = iVar11 + iVar17;
        ...
        *(undefined1 *)((int)local_10 + 0xf) = *(undefined1 *)((&DAT_006439d8)[uVar15] + uVar14);
        ...
        _DAT_0059bb98 = (double)CONCAT44(DAT_0059bb98_4,iVar18);
        _DAT_0059bcc8 = (double)CONCAT44(DAT_0059bcc8_4,iVar11);
        local_18 = local_18 + -1;
      } while (local_18 != 0);
    }
