/*
 * Program: i76.exe
 * Function: update_runtime_clock_from_gettickcount
 * Entry: 0049c920
 * Signature: undefined __stdcall update_runtime_clock_from_gettickcount(void)
 */
...
void update_runtime_clock_from_gettickcount(void)

{
  ...
  undefined3 extraout_var;
                    ...
                    /* I76 semantic baseline: update_runtime_clock_from_gettickcount
                       Per-frame runtime clock update; clamps delta and updates gameplay/session
                       clocks. */
