...

{
  ...
  if (DAT_00504be8 == 0) {
    ...
    iVar2 = _stricmp(&DAT_005dd340,s_zglide_dll_004f9fa4);
    if (((iVar2 == 0) || (iVar2 = _stricmp(&DAT_005dd340,s_zredline_dll_004f9f94), iVar2 == 0)) ||
       (iVar2 = _stricmp(&DAT_005dd340,s_zpowervr_dll_004f9f84), iVar2 == 0)) {
      iVar2 = 1;
    }
    else {
      iVar2 = _stricmp(&DAT_005dd340,s_zdx5draw_dll_004f9f74);
