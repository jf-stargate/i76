/*
 * Program: I76EDIT.EXE
 * Function: thunk_FUN_00404710
 * Entry: 004010fa
 * Signature: undefined4 __cdecl thunk_FUN_00404710(HWND param_1, undefined4 param_2, uint param_3)
 */


undefined4 __cdecl thunk_FUN_00404710(HWND param_1,undefined4 param_2,uint param_3)

{
  ...
  case 1:
    ...
    DAT_00434344 = 3;
    if (iStack_cc != 0) {
      thunk_FUN_00415980((int)DAT_0043433c,0,iStack_cc,iVar5);
    }
    break;
  case 2:
    uVar1 = GetAsyncKeyState(0x11);
  ...
  case 6:
    ...
    if (DAT_0043433c != (int *)0x0) {
      ...
      if ((aiStack_54[DAT_00434344 / 3 + -5] == 0) &&
         ...
         iVar3 == 1)) {
        thunk_FUN_004157f0(DAT_0043433c);
      }
