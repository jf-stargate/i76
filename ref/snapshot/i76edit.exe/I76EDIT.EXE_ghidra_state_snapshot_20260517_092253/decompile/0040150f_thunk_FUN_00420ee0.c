/*
 * Program: I76EDIT.EXE
 * Function: thunk_FUN_00420ee0
 * Entry: 0040150f
 * Signature: undefined4 __cdecl thunk_FUN_00420ee0(int * param_1)
 */


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

undefined4 __cdecl thunk_FUN_00420ee0(int *param_1)
    ...
    do {
      ...
      *(uint *)(iVar2 + 0x50) = *(uint *)(iVar2 + 0x50) & 0xfffffffe;
      if ((*(float *)(iVar2 + 0x10) == *(float *)(iVar2 + 0x34)) &&
        ...
        thunk_FUN_004157f0(piVar3);
        return 1;
      }
      piVar3 = (int *)*piVar3;
    } while (piVar3 != (int *)0x0);
    while (param_1 != (int *)0x0) {
      iVar2 = thunk_FUN_004024d0((int)param_1);
      DAT_004379c8 = 0xbf800000;
      DAT_004379cc = 0xbf800000;
      DAT_004379d0 = 0xbf800000;
      DAT_004379d8 = 0xbf800000;
