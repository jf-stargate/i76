/*
 * Program: I76EDIT.EXE
 * Function: thunk_FUN_0041b150
 * Entry: 004010cd
 * Signature: undefined __cdecl thunk_FUN_0041b150(char * param_1, int param_2)
 */


void __cdecl thunk_FUN_0041b150(char *param_1,int param_2)

{
  ...
  if (param_2 == 1) {
    thunk_FUN_0041e120(s_Exporting____00436814);
    puVar3 = _malloc(8);
    *puVar3 = 0x32445742;
    puVar3[1] = 8;
    __write(iVar6,puVar3,8);
    FUN_0041bcf0(iVar6,&DAT_00564552,2);
    puVar3 = _realloc(puVar3,8);
    *puVar3 = 0x46454457;
    puVar3[1] = 8;
    lVar4 = __tell(iVar6);
    __write(iVar6,puVar3,8);
    iVar9 = FUN_0041bcf0(iVar6,0x56455257,8);
    ...
    *(undefined2 *)puVar16 = *(undefined2 *)puVar11;
    ...
    iVar10 = thunk_FUN_0041bcb0(iVar6);
    ...
    *puVar3 = 0x46454457;
    ...
    puVar3 = _realloc(puVar3,8);
    *puVar3 = 0x46454454;
    _Buf = (void *)thunk_FUN_0041adc0((undefined4 *)&stack0xfffffbd0,param_1,unaff_EBP,unaff_EDI,
                                      unaff_ESI,unaff_EBX,_MaxCharCount,uVar7);
    lVar4 = __tell(iVar6);
    __write(iVar6,puVar3,8);
    __write(iVar6,_Buf,(uint)_MaxCharCount);
    _free(_Buf);
    iVar9 = thunk_FUN_0041bcb0(iVar6);
    ...
    *puVar3 = 0x46454452;
    lVar4 = __tell(iVar6);
    __write(iVar6,puVar3,8);
    iVar9 = FUN_0041bcf0(iVar6,0x56455252,1);
    iVar10 = thunk_FUN_00415e30(iVar6);
    iVar9 = iVar9 + iVar10;
    iVar10 = thunk_FUN_0041bcb0(iVar6);
    puVar3[1] = iVar9 + iVar10 + 8;
    lVar5 = __tell(iVar6);
    ...
    *puVar3 = 0x4645444f;
    lVar4 = __tell(iVar6);
    __write(iVar6,puVar3,8);
    thunk_FUN_0041e120(s_Exporting_Objects__004367fc);
    iVar9 = FUN_0041bcf0(iVar6,0x5645524f,3);
    iVar10 = thunk_FUN_0040a400(iVar6,uVar7);
    iVar9 = iVar9 + iVar10;
    iVar10 = thunk_FUN_0041bcb0(iVar6);
    puVar3[1] = iVar9 + iVar10 + 8;
    lVar5 = __tell(iVar6);
    ...
    __write(iVar6,puVar3,8);
    __lseek(iVar6,lVar5,0);
    thunk_FUN_0041e120(s_Exporting_Linked_Objects__004367dc);
    puVar3 = _realloc(puVar3,8);
    *puVar3 = 0x4645444c;
    lVar4 = __tell(iVar6);
    __write(iVar6,puVar3,8);
    iVar9 = FUN_0041bcf0(iVar6,0x5645524c,1);
    iVar10 = thunk_FUN_0040fa00(iVar6);
    iVar9 = iVar9 + iVar10;
    iVar10 = thunk_FUN_0041bcb0(iVar6);
    iVar9 = iVar9 + iVar10;
    ...
    __write(iVar6,puVar3,8);
    __lseek(iVar6,lVar5,0);
    thunk_FUN_0041e120(s_paths_004367d4);
    thunk_FUN_00409050(uVar7);
    __close(uVar7);
    puVar3 = _realloc(puVar3,8);
    *puVar3 = 0x46454441;
    puVar3[1] = 8;
    lVar4 = __tell(iVar6);
    __write(iVar6,puVar3,8);
    iVar9 = FUN_0041bcf0(iVar6,0x56455241,1);
    puVar3 = _realloc(puVar3,8);
    *puVar3 = &DAT_004d5346;
    puVar3[1] = 8;
    lVar5 = __tell(iVar6);
    __write(iVar6,puVar3,8);
    thunk_FUN_0041e120(s_Compiling_FSM__004367c0);
    iVar17 = 0x1c;
