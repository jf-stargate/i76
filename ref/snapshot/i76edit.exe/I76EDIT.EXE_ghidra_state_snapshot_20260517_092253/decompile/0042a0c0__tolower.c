...

{
  ...
  if (_C < 0x100) {
    if (DAT_00438a4c < 2) {
      uVar1 = *(ushort *)(PTR_DAT_00438840 + _C * 2) & 1;
    }
    else {
  ...
  if ((PTR_DAT_00438840[(uint)local_4 * 2 + 1] & 0x80) == 0) {
  ...
  iVar2 = ___crtLCMapStringA(DAT_00438f90,(LPCWSTR)0x100,(DWORD)&local_4,_LpSrcStr,
