 ...
 * Entry: 00426ae7
 * Signature: undefined __fastcall __trandisp2(undefined4 param_1, int param_2)
 */
...

{
  ...
  *(ushort *)(unaff_EBP + -0xa0) =
  ...
  cVar2 = (char)(*(char *)(unaff_EBP + -0x9f) << 1) >> 1;
                    /* WARNING: Could not recover jumptable at 0x00426b71. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (**(code **)(param_2 + (char)((&DAT_004386cd)[(byte)(cVar2 << 1 | cVar2 < '\0') & 0xf] |
                               (&DAT_004386cd)[(byte)((bVar3 & 7) << 1 | (char)bVar3 < '\0')] << 2)
              + 0x10))();
  return;
}
