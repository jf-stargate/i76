/*
 * Program: I76EDIT.EXE
 * Function: thunk_FUN_00409eb0
 * Entry: 004014bf
 * Signature: undefined __cdecl thunk_FUN_00409eb0(int param_1, int param_2)
 */


void __cdecl thunk_FUN_00409eb0(int param_1,int param_2)
    ...
    do {
      ...
      if (uStack_8 != 0) {
        do {
          ...
          uVar2 = thunk_FUN_0041c430((&DAT_00439be8)[iStack_14],(undefined4 *)0x0,(int)_DstBuf);
          *puVar7 = uVar2;
