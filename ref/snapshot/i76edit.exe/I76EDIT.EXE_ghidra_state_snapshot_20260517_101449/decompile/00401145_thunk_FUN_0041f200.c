/*
 * Program: I76EDIT.EXE
 * Function: thunk_FUN_0041f200
 * Entry: 00401145
 * Signature: uint __cdecl thunk_FUN_0041f200(uint param_1, uint param_2)
 */


uint __cdecl thunk_FUN_0041f200(uint param_1,uint param_2)

{
  ...
  if ((-1 < (int)param_1) && (-1 < (int)param_2)) {
    ...
    iVar2 = piVar3[1];
    iVar1 = piVar3[2];
    puVar4 = i76edit_get_terrain_plane_row_ptr(*piVar3,4);
