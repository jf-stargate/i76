...
/* [cgpt_i76edit_level_renames_v3] Loads OBJ chunk object records from the .I76 workspace stream;
   version-gated object record sizes are visible. */
...

{
  ...
  __read(param_1,&local_4,4);
  local_c = 0;
  if (local_4 != 0) {
    do {
      __read(param_1,&local_14,4);
      __read(param_1,&local_8,4);
      local_10 = 0;
      if (local_8 != 0) {
        do {
          ...
          puVar7 = &DAT_00439be8 + local_14;
          uVar2 = i76edit_alloc_linked_list_node3
                            ((&DAT_00439be8)[local_14],(undefined4 *)0x0,(int)_DstBuf);
          *puVar7 = uVar2;
