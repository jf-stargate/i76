 ...
 * Entry: 0042a960
 * Signature: void * __cdecl FID_conflict:_memcpy(void * _Dst, void * _Src, size_t _Size)
 */
...
switchD_0042aa29_caseD_3:
      ...
      switch(uVar1 & 3) {
      case 1:
        goto switchD_0042aa29_caseD_1;
      case 2:
        goto switchD_0042aa29_caseD_2;
      case 3:
        goto switchD_0042aa29_caseD_3;
      }
    }
    return _Dst;
  }
  ...
  if (((uint)_Dst & 3) == 0) {
    ...
    switch(_Size & 3) {
    case 1:
switchD_0042a990_caseD_1:
      *(undefined1 *)puVar3 = *(undefined1 *)_Src;
      return _Dst;
    case 2:
switchD_0042a990_caseD_2:
      *(undefined2 *)puVar3 = *(undefined2 *)_Src;
      return _Dst;
    case 3:
switchD_0042a990_caseD_3:
      *(undefined2 *)puVar3 = *(undefined2 *)_Src;
    ...
    switch(uVar1 & 3) {
    case 1:
      goto switchD_0042a990_caseD_1;
    case 2:
      goto switchD_0042a990_caseD_2;
    case 3:
      goto switchD_0042a990_caseD_3;
    }
  }
  return _Dst;
}
