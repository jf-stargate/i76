...

{
  ...
  do {
      ...
      if (puVar2 == (undefined4 *)0x0) {
        if (DAT_004363ac != (undefined4 *)0x0) {
          ...
          if (param_1 == aiStack_f0[0]) {
            ...
            SetROP2(param_2,6);
            uVar10 = i76edit_find_zone_cell_origin_by_zone_id
                               (aiStack_f0[0],aiStack_f0[1],aiStack_f0[2]);
    ...
    if (((uStack_90 & 1) == 0) &&
       (iVar6 = i76edit_object_type_has_runtime_position_override(iStack_d4), iVar6 == 0)) {
      iVar6 = _atoi(acStack_8c);
      iVar6 = iVar6 / 5;
      iVar4 = _atoi(acStack_83);
      iVar4 = iVar4 / 5;
      uVar11 = i76edit_find_zone_cell_origin_by_zone_id(aiStack_f0[0],aiStack_f0[1],aiStack_f0[2]);
      if ((iVar6 == 0) || (iVar4 == 0)) {
        iVar6 = -1;
        pcVar8 = acStack_d0;
        do {
