...

{
  ...
  i76edit_set_status_bar_text(acStack_100);
...
LAB_004189f0:
        ...
        i76edit_load_object_records(_FileHandle,iStack_11c);
        if (iStack_11c < 3) {
          thunk_FUN_0040f470();
          thunk_FUN_0040f170();
        }
      ...
      if (puStack_124 == (undefined *)0x454e4f5a) {
        ...
        iVar3 = 0;
        i76edit_load_workspace_surface_terrain_tables(_FileHandle,iStack_120);
        do {
          i76edit_convert_zone_id_to_cell_xy(iVar3,&iStack_118,&iStack_104);
          if (iStack_118 != -1) {
