/*
 * Program: I76EDIT.EXE
 * Function: i76edit_winmain_and_message_loop
 * Entry: 00401a90
 * Signature: undefined4 __stdcall i76edit_winmain_and_message_loop(undefined4 param_1, undefined4 param_2, char * param_3)
 */


/* [cgpt_i76edit_level_renames_v2:high] Top-level editor startup/message loop. Evidence:
   title/version strings, command-line usage string, color-depth check,
   DispatchMessage/PeekMessage/TranslateMessage, initial load/render calls. */

undefined4 i76edit_winmain_and_message_loop(undefined4 param_1,undefined4 param_2,char *param_3)

{
  ...
  bVar2 = true;
  iVar13 = 0;
  puVar20 = (uint *)(uint)(ushort)DAT_00434068;
  ...
  bVar4 = i76edit_find_existing_editor_window();
  ...
  DAT_01642370 = i76edit_create_main_window_and_controls();
    ...
    if (uVar11 == 1) {
      ...
      while (pcVar6 != (char *)0x0) {
        ...
        if ((iVar10 == 0) || (iVar10 = __strcmpi(pcVar6,&DAT_00433f04), iVar10 == 0)) {
          _sprintf(local_300,s_Usage__I76edit_filename___n___r__00433e94);
          pcVar6 = local_300;
          UVar19 = 0x40;
      ...
      _File = (FILE *)FUN_004232c0(local_100,&DAT_00433e7c);
      if (_File == (FILE *)0x0) {
        _sprintf(local_300,s_error_opening_file__s_file_may_n_00433e34,local_100);
        pcVar6 = local_300;
        UVar19 = 0x40;
        pcVar18 = s_I76_Edit_00433e88;
        pHVar7 = GetFocus();
      ...
      while (sVar8 = _fread(&stack0xfffffcde,1,1,_File), sVar8 != 0) {
        if ((char)((uint)puVar20 >> 0x10) == '\n') {
          ...
          if (*(char *)(uVar11 + 0x164226b) != '.') {
            _sprintf(local_300,s_Filename_error_in_file___s_00433e10,&DAT_01642270);
            pcVar6 = local_300;
            UVar19 = 0x40;
            pcVar18 = s_I76_Edit_00433e88;
            pHVar7 = GetFocus();
          ...
          *(undefined1 *)((int)&DAT_0164226c + uVar11 + 3) = 0;
          _sprintf(local_300,s_Processing__s____00433dfc,&DAT_01642270);
          i76edit_set_status_bar_text(local_300);
          pcVar6 = local_200;
          ...
          i76edit_load_mission_file(local_200);
          UpdateWindow(DAT_01642370);
          if (bVar2) {
            i76edit_release_render_terrain_pipeline
                      (unaff_EDI,unaff_ESI,unaff_EBX,puVar20,_Str,(ushort *)in_stack_fffffce4,
                       in_stack_fffffce8,in_stack_fffffcec,in_stack_fffffcf0,in_stack_fffffcf4,
                       in_stack_fffffcf8);
            UpdateWindow(DAT_01642370);
          }
          i76edit_export_runtime_mission_file(&DAT_01642270,1);
          if (bVar2) {
            i76edit_save_editor_mission_file(local_200);
          }
          puVar17 = (undefined4 *)&DAT_01642270;
          for (iVar13 = 0x40; iVar13 != 0; iVar13 = iVar13 + -1) {
            *puVar17 = 0;
