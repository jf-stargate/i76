...
/* [cgpt_i76edit_level_renames_v4:medium] Copies/merges 0x280140 terrain planes and normalizes 80x80
   word maps; handles 0x8000 sentinel and surface id values around 0x63/0x64/0xc7. */
