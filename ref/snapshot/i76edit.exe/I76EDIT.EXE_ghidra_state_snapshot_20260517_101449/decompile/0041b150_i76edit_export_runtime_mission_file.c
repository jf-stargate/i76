...
/* [cgpt_i76edit_level_renames_v2:high] Runtime/export path. Evidence: 'Exporting...', 'Exporting
   Objects.', 'Exporting Linked Objects.', file-open/write/seek calls, and file-permission error
   string. */
...

{
  ...
  undefined4 *puVar16;
  int iVar17;
  undefined4 local_424 [7];
  char local_408 [260];
  undefined4 *local_304 [65];
  char local_200 [256];
  ...
  if (DAT_00433a30 == 0) {
    ...
    iVar6 = __open(local_408,0x8301,0x80);
    uVar7 = 0xffffffff;
  ...
  if (DAT_00433a30 == 0) {
    ...
    pcVar2 = _strchr((char *)local_304,0x2e);
    if (pcVar2 == (char *)0x0) {
      uVar7 = 0xffffffff;
  ...
  uVar7 = __open(local_408,0x8301,0x80);
  DAT_0043c540 = (FILE *)FUN_004232c0((char *)local_304,&DAT_004368b4);
  if ((DAT_0043c540 == (FILE *)0x0) && (DAT_00433a30 == 0)) {
    _sprintf(local_200,s_Could_not_open__s_for_writing____0043686c,local_304);
    MessageBoxA(DAT_01642370,local_200,s_WARNING__File_IO_Error_Sharing_V_00436824,0);
  }
  if (param_2 == 1) {
