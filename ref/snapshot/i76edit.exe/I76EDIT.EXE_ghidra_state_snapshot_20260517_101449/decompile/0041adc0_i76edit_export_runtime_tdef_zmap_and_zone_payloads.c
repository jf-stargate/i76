/*
 * Program: I76EDIT.EXE
 * Function: i76edit_export_runtime_tdef_zmap_and_zone_payloads
 * Entry: 0041adc0
 * Signature: undefined __cdecl i76edit_export_runtime_tdef_zmap_and_zone_payloads(undefined4 * param_1, undefined4 param_2, int param_3, ushort * param_4, uint * param_5, uint * param_6, uint * param_7, uint param_8)
 */


/* [cgpt_i76edit_level_renames_v2:medium] References 'Exporting Zone %d of %d.' and opens/writes
   output files; likely zone serializer used during export.
   
   [cgpt_i76edit_level_renames_v6:high] Runtime TDEF exporter. Writes TREV v4, builds ZMAP size
   0x1909 with one-byte active-zone count plus 80x80 zone-id map, writes a ZONE descriptor, opens a
   side payload stream, then emits one 0x8000 packed zone payload per active zone. */

void __cdecl
i76edit_export_runtime_tdef_zmap_and_zone_payloads
          (undefined4 *param_1,undefined4 param_2,int param_3,ushort *param_4,uint *param_5,
...

{
  ...
  *puVar3 = 0x56455254;
  ...
  do {
    iVar12 = 0;
    do {
      iVar4 = i76edit_get_or_assign_zone_map_cell_id(iVar12,iVar6,0);
...
LAB_0041b010:
  ...
  if ('\0' < cVar17) {
    do {
      ...
      i76edit_set_status_bar_text(&stack0x0000023c);
      i76edit_export_runtime_zone_128x128_packed_height_surface
                (puVar16,_FileHandle,unaff_EBP,CONCAT44(unaff_ESI,unaff_EDI),unaff_EBX,unaff_retaddr
                 ,puVar3,0x56455254,0xc,(ushort *)0x4,param_5,param_6,param_7,param_8);
      puVar16 = puVar1;
