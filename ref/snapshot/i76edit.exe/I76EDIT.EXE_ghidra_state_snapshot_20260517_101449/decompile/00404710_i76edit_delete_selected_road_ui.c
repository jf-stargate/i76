...
/* [cgpt_i76edit_level_renames_v2:medium] References 'Delete this road?' and 'Delete Road'; UI
   command path for road deletion. */
...

{
  ...
  case 1:
    ...
    if ((uVar1 & 0x8000) == 0) {
      ...
      iVar5 = (int)uVar8;
      if (local_cc != 0) {
        puVar2 = (uint *)thunk_FUN_00415a00(local_54,local_cc);
        puVar6 = local_a8;
    ...
    local_c8 = uVar7;
    local_c0 = uVar7;
    DAT_0043433c = (int *)thunk_FUN_00415440(0,(int *)&local_c8,(short)DAT_00434350);
    DAT_00434344 = 3;
    if (local_cc != 0) {
      i76edit_link_road_edge_neighbors((int)DAT_0043433c,0,local_cc,iVar5);
    }
    break;
  case 2:
    uVar1 = GetAsyncKeyState(0x11);
    ...
    local_c8 = uVar7;
    local_c0 = uVar7;
    DAT_0043433c = (int *)thunk_FUN_00415440(1,(int *)&local_c8,(short)DAT_00434350);
    DAT_00434344 = 3;
    if (local_cc != 0) {
      i76edit_link_road_edge_neighbors((int)DAT_0043433c,0,local_cc,iVar5);
    }
  ...
  case 4:
    ...
    if (DAT_0043433c != (int *)0x0) {
      puVar2 = (uint *)thunk_FUN_00415a00(local_54,(int)DAT_0043433c);
      puVar6 = local_a8;
      for (iVar3 = 0x15; iVar3 != 0; iVar3 = iVar3 + -1) {
        *puVar6 = *puVar2;
        puVar2 = puVar2 + 1;
      ...
      SendDlgItemMessageA(DAT_01642390,0x414,0x14e,local_a8[1] & 0xffff,0);
    }
    break;
  case 5:
  ...
  case 6:
    ...
    if (DAT_0043433c != (int *)0x0) {
      ...
      SendDlgItemMessageA(DAT_01642390,0x414,0x14e,local_a8[1] & 0xffff,0);
      if ((local_54[DAT_00434344 / 3 + -5] == 0) &&
