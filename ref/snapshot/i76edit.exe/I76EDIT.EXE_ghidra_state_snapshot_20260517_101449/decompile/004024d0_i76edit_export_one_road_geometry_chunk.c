...
/* [cgpt_i76edit_level_renames_v5:medium] Called by runtime road export; writes per-road
   geometry/segment data and participates in road chunk body size accumulation. */
