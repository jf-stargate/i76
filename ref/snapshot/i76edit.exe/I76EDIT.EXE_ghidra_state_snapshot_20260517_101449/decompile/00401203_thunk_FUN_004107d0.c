...

{
  ...
  uVar1 = i76edit_get_or_create_zone_surface_sample(param_1,param_2,1);
  if (uVar1 == 0x8000) {
    uVar2 = i76edit_get_or_create_zone_surface_sample(param_1 - 1,param_2,1);
    uVar1 = 0;
    if (uVar2 != 0x8000) {
      uVar1 = uVar2;
    }
    ...
    uVar2 = i76edit_get_or_create_zone_surface_sample(param_1,param_2 - 1,1);
    if (uVar2 != 0x8000) {
      uVar3 = uVar3 + 1;
      uVar1 = uVar1 + uVar2;
    }
    ...
    uVar2 = i76edit_get_or_create_zone_surface_sample(param_1 - 1,param_2 - 1,1);
    if (uVar2 != 0x8000) {
      uVar3 = uVar3 + 1;
      uVar1 = uVar1 + uVar2;
    }
