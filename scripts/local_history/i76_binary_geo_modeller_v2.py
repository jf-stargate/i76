#!/usr/bin/env python3
"""
i76_binary_geo_modeller_v2.py

Second-pass Interstate '76 binary-faithful vehicle GEO modeller with explicit OBJ/raster orientation probes.
...
def write_runtime_obj_mtl(helper, resolver, idx, vehicle_dir: Path, vehicle_name: str, part_models: List[Dict[str, object]],
                          ...
                          textured_kd_mode: str, flat_color_mode: str, obj_v_mode: str, obj_u_mode: str, render_corner_order: str, texture_image_transform: str):
    ...
    with obj_path.open("w", encoding="utf-8") as obj:
        ...
        for pm in part_models:
            ...
            for sec in sections:
                if render_corner_order == "source":
                    corner_order = list(sec.corners_original_order)
                else:
                    corner_order = list(sec.corners_render_order)
    ...
    for vcf in vcf_assets:
        ...
        if part_models:
            obj_path, mtl_path, materials, face_rows, corner_rows = write_runtime_obj_mtl(
                ...
                args.flat_color_mode, args.obj_v_mode, args.obj_u_mode, args.render_corner_order, args.texture_image_transform,
            )
