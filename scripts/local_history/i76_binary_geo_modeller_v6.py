...
Validation note:
  ...
  material binding, or global UV flip.  v6 defaults to the validated mirror-X negative-determinant OBJ view transform while leaving the runtime model in original game coordinates. It also restores GEO polygon face color as the default textured material Kd; use --textured-kd-mode white to preserve the prior Blender-neutral preview.
"""
