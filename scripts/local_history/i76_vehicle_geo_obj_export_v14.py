#!/usr/bin/env python3
"""
i76_vehicle_geo_obj_export_v14.py
...
Usage:
  python3 i76_vehicle_geo_obj_export_v14.py \
      --zfs I76.ZFS \
      --zix I76.ZIX \
...
Export all vehicles with VDF/VTF:
  python3 i76_vehicle_geo_obj_export_v14.py --zfs I76.ZFS --zix I76.ZIX \
      --resolver i76_vehicle_texture_slot_resolver_v5.py \
...
def write_obj_mtl(vehicle_dir: Path, vehicle_name: str, part_rows: List[Tuple], export_textures: bool, resolver, idx, palette_rgb: Optional[bytes] = None, flat_color_mode: str = "auto"):
...
def main() -> int:
    ...
    (args.out / "README.txt").write_text("""I76 vehicle GEO OBJ exporter v14
