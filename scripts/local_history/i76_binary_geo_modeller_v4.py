#!/usr/bin/env python3
"""
i76_binary_geo_modeller_v4.py

Fourth-pass Interstate '76 binary-faithful vehicle GEO modeller with a validated handedness-aware OBJ view default.
...
Validation note:
  ...
  material binding, or global UV flip.  v4 therefore defaults to an I76 Y-up ->
  Blender Z-up negative-determinant view transform while leaving the runtime model
  in original game coordinates.
"""
...
def main() -> int:
    ...
    ap.add_argument("--obj-geometry-transform", choices=["identity", "mirror-x", "mirror-y", "mirror-z", "blender-xzy", "blender-xzy-rh", "i76-yup-to-blender-zup"], default="i76-yup-to-blender-zup", help="Final OBJ-view coordinate transform. Default maps I76 Y-up/XZ-ground coordinates into Blender Z-up with the negative handedness conversion validated by mirrored-text probes.")
...
Orientation probes:
  ...
  --obj-geometry-transform identity|mirror-x|mirror-y|mirror-z|blender-xzy|blender-xzy-rh|i76-yup-to-blender-zup changes only the final OBJ coordinate view. v4 defaults to i76-yup-to-blender-zup, preserving the runtime model while exporting a Blender-oriented negative-determinant view.
""", encoding="utf-8")
