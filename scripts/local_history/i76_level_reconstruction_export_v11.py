#!/usr/bin/env python3
"""
Interstate '76 level reconstruction exporter, v11.
...
def export(args: argparse.Namespace) -> dict:
    ...
    out_dir = timestamped_out_dir(args.out_dir, "i76_level_reconstruction_export_v11")
    ...
    manifest = {
        ...
        "runtime_approximate": [
            ...
            "GEO geometry instantiation is not yet wired into this revision; v11 resolves embedded GEO names when the resolver is available but does not extract meshes",
        ],
        "missions": [],
        "warnings": [],
    }
    ...
    for msn in sorted(missions):
        try:
            ...
            for parent_tag, recs in (("ODEF", odef_records), ("LDEF", ldef_records)):
                ...
                res_rows, sdf_rows, unresolved = build_resolution_rows(msn.stem.lower(), msn, recs, file_index, parent_tag)
    ...
    notes = [
        "i76_level_reconstruction_export_v11 notes",
        "",
