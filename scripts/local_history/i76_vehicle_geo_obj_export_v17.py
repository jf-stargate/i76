#!/usr/bin/env python3
"""
i76_vehicle_geo_obj_export_v17.py
...
Usage:
  python3 i76_vehicle_geo_obj_export_v17.py \
      --zfs I76.ZFS \
      --zix I76.ZIX \
...
Export all vehicles with VDF/VTF:
  python3 i76_vehicle_geo_obj_export_v17.py --zfs I76.ZFS --zix I76.ZIX \
      --resolver i76_vehicle_texture_slot_resolver_v5.py \
...
def write_obj_mtl(vehicle_dir: Path, vehicle_name: str, part_rows: List[Tuple], export_textures: bool, resolver, idx, palette_rgb: Optional[bytes] = None, flat_color_mode: str = "auto", vqm_layout: str = "yx", direct_map_prefer: str = "current", textured_kd_mode: str = "white"):
...
def main() -> int:
    ...
    for vcf in vcf_assets:
        ...
        if part_rows:
            ...
            obj_path, mtl_path, materials, report = write_obj_mtl(vdir, vcf.name, part_rows, args.export_textures, resolver, idx, palette_rgb, flat_color_mode, args.vqm_layout, args.direct_map_prefer, args.textured_kd_mode)
    ...
    (args.out / "README.txt").write_text("""I76 vehicle GEO OBJ exporter v17
