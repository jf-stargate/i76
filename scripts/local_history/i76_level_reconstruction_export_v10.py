#!/usr/bin/env python3
"""
Interstate '76 level reconstruction exporter, v10.
...
def export(args: argparse.Namespace) -> dict:
    ...
    out_dir = timestamped_out_dir(args.out_dir, "i76_level_reconstruction_export_v10")
    ...
    manifest = {
        ...
        "runtime_approximate": [
            ...
            "GEO geometry instantiation is not yet wired into this revision; v10 resolves embedded GEO names but does not extract meshes",
        ],
        "missions": [],
        "warnings": [],
    }
    ...
    notes = [
        "i76_level_reconstruction_export_v10 notes",
        "",
