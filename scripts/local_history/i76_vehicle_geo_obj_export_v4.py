#!/usr/bin/env python3
"""
i76_vehicle_geo_obj_export_v4.py
...
Usage:
  python3 i76_vehicle_geo_obj_export_v4.py \
      --zfs I76.ZFS \
      --zix I76.ZIX \
      --resolver i76_vehicle_texture_slot_resolver_v5.py \
      --out i76_vehicle_geo_obj_v4 \
      --vehicle vcpolic1 \
      --export-textures \
      --overwrite

Export all vehicles with VDF/VTF:
  python3 i76_vehicle_geo_obj_export_v4.py --zfs I76.ZFS --zix I76.ZIX \
      --resolver i76_vehicle_texture_slot_resolver_v5.py \
      --out i76_vehicle_geo_obj_v4 --all --overwrite
"""
