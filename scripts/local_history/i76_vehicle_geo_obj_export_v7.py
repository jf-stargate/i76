#!/usr/bin/env python3
"""
i76_vehicle_geo_obj_export_v7.py
...
Usage:
  python3 i76_vehicle_geo_obj_export_v7.py \
      --zfs I76.ZFS \
      --zix I76.ZIX \
      --resolver i76_vehicle_texture_slot_resolver_v5.py \
      --out i76_vehicle_geo_obj_v7 \
      --vehicle vcpolic1 \
      --export-textures \
      --overwrite

Export all vehicles with VDF/VTF:
  python3 i76_vehicle_geo_obj_export_v7.py --zfs I76.ZFS --zix I76.ZIX \
      --resolver i76_vehicle_texture_slot_resolver_v5.py \
      --out i76_vehicle_geo_obj_v7 --all --overwrite
"""
...
def resolve_resource_ref_with_prefix_fallback(resolver, idx, ref: str, ext: str, source):
    ...
    Try exact, resolver's leading-byte trim, then a few known game prefixes.
    """
    if not ref:
        return None
    if "." not in ref:
