...
def main() -> int:
    ...
    ap.add_argument("--texture-alpha-mode", choices=["transparent-flags", "index-ff", "opaque"], default="opaque", help="PNG alpha export policy. Default opaque is source-truth-safe for OBJ export; transparent-flags maps palette index 0xff to alpha only for textured faces whose GEO SurfaceFlags2 is 5 or 7; index-ff applies alpha globally to every texture using palette index 0xff.")
