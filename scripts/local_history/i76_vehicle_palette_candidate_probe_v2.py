#!/usr/bin/env python3
"""
i76_vehicle_palette_candidate_probe_v2.py
...
def main() -> int:
    ...
    for asset in assets:
        ...
        rows = contact_sheet_for_texture(args.out, asset.name, w, h, pix, palettes, args.max_palettes, args.write_individual_renders)
